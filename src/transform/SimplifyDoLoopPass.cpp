// Copied from https://github.com/shuyadav-dev/llvm-project/blob/eaedd0d569f472d2236873f8bd95eecd9d9cab88/flang/lib/Optimizer/Transforms/SimplifyDoLoop.cpp
// Used for test only!
...
void registerSimplifyDoLoopPass() {
  ::mlir::registerPass(
      []() -> std::unique_ptr<mlir::Pass> { return createSimplifyDoLoopPass(); });
};
} // namespace xla_jit
