...
static bool affineCmp(AffineExpr lhs, AffineExpr rhs) {
...
static SmallVector<AffineExpr> getSumOperands(AffineExpr expr) {
...
static AffineExpr sortSum(AffineExpr expr) {
...
static AffineExpr commonAddWithMul(AffineExpr LHS, AffineExpr RHS,
...
IntegerSet recreateExpr(IntegerSet map) {
