...
extern HloInputs_LiteralDescriptorDefaultTypeInternal _HloInputs_LiteralDescriptor_default_instance_;
...
extern OriginalValueRecoveryTableProtoDefaultTypeInternal _OriginalValueRecoveryTableProto_default_instance_;
class OriginalValueRecoveryTableProto_Entry;
struct OriginalValueRecoveryTableProto_EntryDefaultTypeInternal;
extern OriginalValueRecoveryTableProto_EntryDefaultTypeInternal _OriginalValueRecoveryTableProto_Entry_default_instance_;
...
template<> ::xla::HloInputs_LiteralDescriptor* Arena::CreateMaybeMessage<::xla::HloInputs_LiteralDescriptor>(Arena*);
...
template<> ::xla::OriginalValueRecoveryTableProto* Arena::CreateMaybeMessage<::xla::OriginalValueRecoveryTableProto>(Arena*);
template<> ::xla::OriginalValueRecoveryTableProto_Entry* Arena::CreateMaybeMessage<::xla::OriginalValueRecoveryTableProto_Entry>(Arena*);
...
constexpr HloModuleProto_ProfileType HloModuleProto_ProfileType_ProfileType_MAX = HloModuleProto_ProfileType_SCHEDULE;
...
class HloModuleProto final :
 ...
 public:
  ...
  static constexpr ProfileType SCHEDULE =
    HloModuleProto_ProfileType_SCHEDULE;
  ...
  private:
  bool _internal_has_original_value_recovery_table() const;
  public:
  ...
  void set_allocated_original_value_recovery_table(::xla::OriginalValueRecoveryTableProto* original_value_recovery_table);
  private:
  ...
  public:
  void unsafe_arena_set_allocated_original_value_recovery_table(
      ::xla::OriginalValueRecoveryTableProto* original_value_recovery_table);
...
class HloInputs_LiteralDescriptor final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.HloInputs.LiteralDescriptor) */ {
 public:
  inline HloInputs_LiteralDescriptor() : HloInputs_LiteralDescriptor(nullptr) {}
  ~HloInputs_LiteralDescriptor() override;
  explicit PROTOBUF_CONSTEXPR HloInputs_LiteralDescriptor(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  HloInputs_LiteralDescriptor(const HloInputs_LiteralDescriptor& from);
  HloInputs_LiteralDescriptor(HloInputs_LiteralDescriptor&& from) noexcept
  ...
  friend void swap(HloInputs_LiteralDescriptor& a, HloInputs_LiteralDescriptor& b) {
    a.Swap(&b);
  }
  ...
  HloInputs_LiteralDescriptor* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<HloInputs_LiteralDescriptor>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const HloInputs_LiteralDescriptor& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const HloInputs_LiteralDescriptor& from) {
    HloInputs_LiteralDescriptor::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.HloInputs.LiteralDescriptor";
  }
  protected:
  explicit HloInputs_LiteralDescriptor(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class HloInputs final :
 ...
 public:
  ...
  typedef HloInputs_LiteralDescriptor LiteralDescriptor;
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::HloInputs_LiteralDescriptor >*
      mutable_arguments_descriptors();
  private:
  const ::xla::HloInputs_LiteralDescriptor& _internal_arguments_descriptors(int index) const;
  ::xla::HloInputs_LiteralDescriptor* _internal_add_arguments_descriptors();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::HloInputs_LiteralDescriptor >&
      arguments_descriptors() const;
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::LiteralProto > arguments_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::HloInputs_LiteralDescriptor > arguments_descriptors_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_xla_2fservice_2fhlo_2eproto;
...
class OriginalValueRecoveryTableProto_Entry final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.OriginalValueRecoveryTableProto.Entry) */ {
 public:
  inline OriginalValueRecoveryTableProto_Entry() : OriginalValueRecoveryTableProto_Entry(nullptr) {}
  ~OriginalValueRecoveryTableProto_Entry() override;
  explicit PROTOBUF_CONSTEXPR OriginalValueRecoveryTableProto_Entry(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  OriginalValueRecoveryTableProto_Entry(const OriginalValueRecoveryTableProto_Entry& from);
  OriginalValueRecoveryTableProto_Entry(OriginalValueRecoveryTableProto_Entry&& from) noexcept
  ...
  friend void swap(OriginalValueRecoveryTableProto_Entry& a, OriginalValueRecoveryTableProto_Entry& b) {
    a.Swap(&b);
  }
  ...
  OriginalValueRecoveryTableProto_Entry* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<OriginalValueRecoveryTableProto_Entry>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const OriginalValueRecoveryTableProto_Entry& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const OriginalValueRecoveryTableProto_Entry& from) {
    OriginalValueRecoveryTableProto_Entry::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.OriginalValueRecoveryTableProto.Entry";
  }
  protected:
  explicit OriginalValueRecoveryTableProto_Entry(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kOldOriginalArrayFieldNumber = 1,
    kNewOriginalArrayFieldNumber = 2,
    kRecoveryModuleFieldNumber = 3,
  };
  // .xla.OriginalArrayProto old_original_array = 1;
  bool has_old_original_array() const;
  private:
  bool _internal_has_old_original_array() const;
  public:
  void clear_old_original_array();
  const ::xla::OriginalArrayProto& old_original_array() const;
  PROTOBUF_NODISCARD ::xla::OriginalArrayProto* release_old_original_array();
  ::xla::OriginalArrayProto* mutable_old_original_array();
  void set_allocated_old_original_array(::xla::OriginalArrayProto* old_original_array);
  private:
  const ::xla::OriginalArrayProto& _internal_old_original_array() const;
  ::xla::OriginalArrayProto* _internal_mutable_old_original_array();
  public:
  void unsafe_arena_set_allocated_old_original_array(
      ::xla::OriginalArrayProto* old_original_array);
  ::xla::OriginalArrayProto* unsafe_arena_release_old_original_array();

  // .xla.OriginalArrayProto new_original_array = 2;
  bool has_new_original_array() const;
  private:
  bool _internal_has_new_original_array() const;
  public:
  void clear_new_original_array();
  const ::xla::OriginalArrayProto& new_original_array() const;
  PROTOBUF_NODISCARD ::xla::OriginalArrayProto* release_new_original_array();
  ::xla::OriginalArrayProto* mutable_new_original_array();
  void set_allocated_new_original_array(::xla::OriginalArrayProto* new_original_array);
  private:
  const ::xla::OriginalArrayProto& _internal_new_original_array() const;
  ::xla::OriginalArrayProto* _internal_mutable_new_original_array();
  public:
  void unsafe_arena_set_allocated_new_original_array(
      ::xla::OriginalArrayProto* new_original_array);
  ::xla::OriginalArrayProto* unsafe_arena_release_new_original_array();

  // .xla.HloModuleProto recovery_module = 3;
  bool has_recovery_module() const;
  private:
  bool _internal_has_recovery_module() const;
  public:
  ...
  void set_allocated_recovery_module(::xla::HloModuleProto* recovery_module);
  private:
  const ::xla::HloModuleProto& _internal_recovery_module() const;
  ::xla::HloModuleProto* _internal_mutable_recovery_module();
  public:
  void unsafe_arena_set_allocated_recovery_module(
      ::xla::HloModuleProto* recovery_module);
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::xla::OriginalArrayProto* old_original_array_;
    ::xla::OriginalArrayProto* new_original_array_;
...
class OriginalValueRecoveryTableProto final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.OriginalValueRecoveryTableProto) */ {
 public:
  inline OriginalValueRecoveryTableProto() : OriginalValueRecoveryTableProto(nullptr) {}
  ~OriginalValueRecoveryTableProto() override;
  explicit PROTOBUF_CONSTEXPR OriginalValueRecoveryTableProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  OriginalValueRecoveryTableProto(const OriginalValueRecoveryTableProto& from);
  OriginalValueRecoveryTableProto(OriginalValueRecoveryTableProto&& from) noexcept
  ...
  friend void swap(OriginalValueRecoveryTableProto& a, OriginalValueRecoveryTableProto& b) {
    a.Swap(&b);
  }
  ...
  OriginalValueRecoveryTableProto* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<OriginalValueRecoveryTableProto>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const OriginalValueRecoveryTableProto& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const OriginalValueRecoveryTableProto& from) {
    OriginalValueRecoveryTableProto::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.OriginalValueRecoveryTableProto";
  }
  protected:
  explicit OriginalValueRecoveryTableProto(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  typedef OriginalValueRecoveryTableProto_Entry Entry;
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::OriginalValueRecoveryTableProto_Entry >*
      mutable_entries();
  private:
  const ::xla::OriginalValueRecoveryTableProto_Entry& _internal_entries(int index) const;
  ::xla::OriginalValueRecoveryTableProto_Entry* _internal_add_entries();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::OriginalValueRecoveryTableProto_Entry >&
      entries() const;
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::OriginalValueRecoveryTableProto_Entry > entries_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_xla_2fservice_2fhlo_2eproto;
...
// int32 end_line = 5;
inline void StackFrameIndexProto_FileLocation::clear_end_line() {
  _impl_.end_line_ = 0;
}
inline int32_t StackFrameIndexProto_FileLocation::_internal_end_line() const {
  return _impl_.end_line_;
}
inline int32_t StackFrameIndexProto_FileLocation::end_line() const {
  // @@protoc_insertion_point(field_get:xla.StackFrameIndexProto.FileLocation.end_line)
  return _internal_end_line();
}
inline void StackFrameIndexProto_FileLocation::_internal_set_end_line(int32_t value) {
  
  _impl_.end_line_ = value;
}
inline void StackFrameIndexProto_FileLocation::set_end_line(int32_t value) {
  _internal_set_end_line(value);
  // @@protoc_insertion_point(field_set:xla.StackFrameIndexProto.FileLocation.end_line)
}
...
// int32 end_column = 6;
inline void StackFrameIndexProto_FileLocation::clear_end_column() {
  _impl_.end_column_ = 0;
}
inline int32_t StackFrameIndexProto_FileLocation::_internal_end_column() const {
  return _impl_.end_column_;
}
inline int32_t StackFrameIndexProto_FileLocation::end_column() const {
  // @@protoc_insertion_point(field_get:xla.StackFrameIndexProto.FileLocation.end_column)
  return _internal_end_column();
}
inline void StackFrameIndexProto_FileLocation::_internal_set_end_column(int32_t value) {
  
  _impl_.end_column_ = value;
}
inline void StackFrameIndexProto_FileLocation::set_end_column(int32_t value) {
  _internal_set_end_column(value);
  // @@protoc_insertion_point(field_set:xla.StackFrameIndexProto.FileLocation.end_column)
}
...
inline ::xla::ProfileGenerationStrategy HloModuleProto_ProfileInfo::_internal_profile_generation_strategy() const {
  return static_cast< ::xla::ProfileGenerationStrategy >(_impl_.profile_generation_strategy_);
}
inline ::xla::ProfileGenerationStrategy HloModuleProto_ProfileInfo::profile_generation_strategy() const {
...
inline void HloModuleProto_ProfileInfo::_internal_set_profile_generation_strategy(::xla::ProfileGenerationStrategy value) {
  
  _impl_.profile_generation_strategy_ = value;
}
inline void HloModuleProto_ProfileInfo::set_profile_generation_strategy(::xla::ProfileGenerationStrategy value) {
...
// .xla.OriginalValueRecoveryTableProto original_value_recovery_table = 20;
inline bool HloModuleProto::_internal_has_original_value_recovery_table() const {
  return this != internal_default_instance() && _impl_.original_value_recovery_table_ != nullptr;
}
inline bool HloModuleProto::has_original_value_recovery_table() const {
  return _internal_has_original_value_recovery_table();
}
...
inline const ::xla::OriginalValueRecoveryTableProto& HloModuleProto::_internal_original_value_recovery_table() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::xla::OriginalValueRecoveryTableProto&>(
      ::xla::_OriginalValueRecoveryTableProto_default_instance_);
}
inline const ::xla::OriginalValueRecoveryTableProto& HloModuleProto::original_value_recovery_table() const {
...
inline void HloModuleProto::unsafe_arena_set_allocated_original_value_recovery_table(
    ::xla::OriginalValueRecoveryTableProto* original_value_recovery_table) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.original_value_recovery_table_);
  }
  _impl_.original_value_recovery_table_ = original_value_recovery_table;
...
inline ::xla::OriginalValueRecoveryTableProto* HloModuleProto::_internal_mutable_original_value_recovery_table() {
  ...
  if (_impl_.original_value_recovery_table_ == nullptr) {
    auto* p = CreateMaybeMessage<::xla::OriginalValueRecoveryTableProto>(GetArenaForAllocation());
    _impl_.original_value_recovery_table_ = p;
  }
  return _impl_.original_value_recovery_table_;
}
inline ::xla::OriginalValueRecoveryTableProto* HloModuleProto::mutable_original_value_recovery_table() {
...
inline void HloModuleProto::set_allocated_original_value_recovery_table(::xla::OriginalValueRecoveryTableProto* original_value_recovery_table) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.original_value_recovery_table_;
  }
  if (original_value_recovery_table) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(original_value_recovery_table);
    if (message_arena != submessage_arena) {
      original_value_recovery_table = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, original_value_recovery_table, submessage_arena);
    }
...
// .xla.PrimitiveType element_type = 4;
inline void BufferAllocationProto_Assigned::clear_element_type() {
  _impl_.element_type_ = 0;
}
inline ::xla::PrimitiveType BufferAllocationProto_Assigned::_internal_element_type() const {
  return static_cast< ::xla::PrimitiveType >(_impl_.element_type_);
}
inline ::xla::PrimitiveType BufferAllocationProto_Assigned::element_type() const {
  // @@protoc_insertion_point(field_get:xla.BufferAllocationProto.Assigned.element_type)
  return _internal_element_type();
}
inline void BufferAllocationProto_Assigned::_internal_set_element_type(::xla::PrimitiveType value) {
  
  _impl_.element_type_ = value;
}
inline void BufferAllocationProto_Assigned::set_element_type(::xla::PrimitiveType value) {
  _internal_set_element_type(value);
  // @@protoc_insertion_point(field_set:xla.BufferAllocationProto.Assigned.element_type)
}
...
inline int HloInputs::_internal_arguments_descriptors_size() const {
  return _impl_.arguments_descriptors_.size();
}
...
inline ::xla::HloInputs_LiteralDescriptor* HloInputs::mutable_arguments_descriptors(int index) {
  ...
  return _impl_.arguments_descriptors_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::HloInputs_LiteralDescriptor >*
HloInputs::mutable_arguments_descriptors() {
  // @@protoc_insertion_point(field_mutable_list:xla.HloInputs.arguments_descriptors)
  return &_impl_.arguments_descriptors_;
}
inline const ::xla::HloInputs_LiteralDescriptor& HloInputs::_internal_arguments_descriptors(int index) const {
  return _impl_.arguments_descriptors_.Get(index);
}
inline const ::xla::HloInputs_LiteralDescriptor& HloInputs::arguments_descriptors(int index) const {
  ...
  return _internal_arguments_descriptors(index);
}
inline ::xla::HloInputs_LiteralDescriptor* HloInputs::_internal_add_arguments_descriptors() {
  return _impl_.arguments_descriptors_.Add();
}
inline ::xla::HloInputs_LiteralDescriptor* HloInputs::add_arguments_descriptors() {
  ::xla::HloInputs_LiteralDescriptor* _add = _internal_add_arguments_descriptors();
  // @@protoc_insertion_point(field_add:xla.HloInputs.arguments_descriptors)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::HloInputs_LiteralDescriptor >&
HloInputs::arguments_descriptors() const {
...
// .xla.OriginalArrayProto old_original_array = 1;
inline bool OriginalValueRecoveryTableProto_Entry::_internal_has_old_original_array() const {
  return this != internal_default_instance() && _impl_.old_original_array_ != nullptr;
}
inline bool OriginalValueRecoveryTableProto_Entry::has_old_original_array() const {
  return _internal_has_old_original_array();
}
inline const ::xla::OriginalArrayProto& OriginalValueRecoveryTableProto_Entry::_internal_old_original_array() const {
  const ::xla::OriginalArrayProto* p = _impl_.old_original_array_;
  return p != nullptr ? *p : reinterpret_cast<const ::xla::OriginalArrayProto&>(
      ::xla::_OriginalArrayProto_default_instance_);
}
inline const ::xla::OriginalArrayProto& OriginalValueRecoveryTableProto_Entry::old_original_array() const {
  // @@protoc_insertion_point(field_get:xla.OriginalValueRecoveryTableProto.Entry.old_original_array)
  return _internal_old_original_array();
}
inline void OriginalValueRecoveryTableProto_Entry::unsafe_arena_set_allocated_old_original_array(
    ::xla::OriginalArrayProto* old_original_array) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.old_original_array_);
  }
  _impl_.old_original_array_ = old_original_array;
  if (old_original_array) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xla.OriginalValueRecoveryTableProto.Entry.old_original_array)
}
inline ::xla::OriginalArrayProto* OriginalValueRecoveryTableProto_Entry::release_old_original_array() {
  
  ::xla::OriginalArrayProto* temp = _impl_.old_original_array_;
...
inline ::xla::OriginalArrayProto* OriginalValueRecoveryTableProto_Entry::unsafe_arena_release_old_original_array() {
  // @@protoc_insertion_point(field_release:xla.OriginalValueRecoveryTableProto.Entry.old_original_array)
  
  ::xla::OriginalArrayProto* temp = _impl_.old_original_array_;
  _impl_.old_original_array_ = nullptr;
  return temp;
}
inline ::xla::OriginalArrayProto* OriginalValueRecoveryTableProto_Entry::_internal_mutable_old_original_array() {
  
  if (_impl_.old_original_array_ == nullptr) {
    auto* p = CreateMaybeMessage<::xla::OriginalArrayProto>(GetArenaForAllocation());
    _impl_.old_original_array_ = p;
  }
  return _impl_.old_original_array_;
}
inline ::xla::OriginalArrayProto* OriginalValueRecoveryTableProto_Entry::mutable_old_original_array() {
  ::xla::OriginalArrayProto* _msg = _internal_mutable_old_original_array();
  // @@protoc_insertion_point(field_mutable:xla.OriginalValueRecoveryTableProto.Entry.old_original_array)
  return _msg;
}
inline void OriginalValueRecoveryTableProto_Entry::set_allocated_old_original_array(::xla::OriginalArrayProto* old_original_array) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.old_original_array_);
  }
  if (old_original_array) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(old_original_array));
    if (message_arena != submessage_arena) {
      old_original_array = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, old_original_array, submessage_arena);
    }
  ...
  _impl_.old_original_array_ = old_original_array;
  // @@protoc_insertion_point(field_set_allocated:xla.OriginalValueRecoveryTableProto.Entry.old_original_array)
}

// .xla.OriginalArrayProto new_original_array = 2;
inline bool OriginalValueRecoveryTableProto_Entry::_internal_has_new_original_array() const {
  return this != internal_default_instance() && _impl_.new_original_array_ != nullptr;
}
inline bool OriginalValueRecoveryTableProto_Entry::has_new_original_array() const {
  return _internal_has_new_original_array();
}
inline const ::xla::OriginalArrayProto& OriginalValueRecoveryTableProto_Entry::_internal_new_original_array() const {
  const ::xla::OriginalArrayProto* p = _impl_.new_original_array_;
  return p != nullptr ? *p : reinterpret_cast<const ::xla::OriginalArrayProto&>(
      ::xla::_OriginalArrayProto_default_instance_);
}
inline const ::xla::OriginalArrayProto& OriginalValueRecoveryTableProto_Entry::new_original_array() const {
  // @@protoc_insertion_point(field_get:xla.OriginalValueRecoveryTableProto.Entry.new_original_array)
  return _internal_new_original_array();
}
inline void OriginalValueRecoveryTableProto_Entry::unsafe_arena_set_allocated_new_original_array(
    ::xla::OriginalArrayProto* new_original_array) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.new_original_array_);
  }
  _impl_.new_original_array_ = new_original_array;
  if (new_original_array) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xla.OriginalValueRecoveryTableProto.Entry.new_original_array)
}
inline ::xla::OriginalArrayProto* OriginalValueRecoveryTableProto_Entry::release_new_original_array() {
  
  ::xla::OriginalArrayProto* temp = _impl_.new_original_array_;
...
inline ::xla::OriginalArrayProto* OriginalValueRecoveryTableProto_Entry::unsafe_arena_release_new_original_array() {
  // @@protoc_insertion_point(field_release:xla.OriginalValueRecoveryTableProto.Entry.new_original_array)
  
  ::xla::OriginalArrayProto* temp = _impl_.new_original_array_;
  _impl_.new_original_array_ = nullptr;
  return temp;
}
inline ::xla::OriginalArrayProto* OriginalValueRecoveryTableProto_Entry::_internal_mutable_new_original_array() {
  
  if (_impl_.new_original_array_ == nullptr) {
    auto* p = CreateMaybeMessage<::xla::OriginalArrayProto>(GetArenaForAllocation());
    _impl_.new_original_array_ = p;
  }
  return _impl_.new_original_array_;
}
inline ::xla::OriginalArrayProto* OriginalValueRecoveryTableProto_Entry::mutable_new_original_array() {
  ::xla::OriginalArrayProto* _msg = _internal_mutable_new_original_array();
  // @@protoc_insertion_point(field_mutable:xla.OriginalValueRecoveryTableProto.Entry.new_original_array)
  return _msg;
}
inline void OriginalValueRecoveryTableProto_Entry::set_allocated_new_original_array(::xla::OriginalArrayProto* new_original_array) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.new_original_array_);
  }
  if (new_original_array) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(new_original_array));
    if (message_arena != submessage_arena) {
      new_original_array = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, new_original_array, submessage_arena);
    }
  ...
  _impl_.new_original_array_ = new_original_array;
  // @@protoc_insertion_point(field_set_allocated:xla.OriginalValueRecoveryTableProto.Entry.new_original_array)
}

// .xla.HloModuleProto recovery_module = 3;
inline bool OriginalValueRecoveryTableProto_Entry::_internal_has_recovery_module() const {
  return this != internal_default_instance() && _impl_.recovery_module_ != nullptr;
}
inline bool OriginalValueRecoveryTableProto_Entry::has_recovery_module() const {
  return _internal_has_recovery_module();
}
...
inline const ::xla::HloModuleProto& OriginalValueRecoveryTableProto_Entry::recovery_module() const {
...
inline void OriginalValueRecoveryTableProto_Entry::unsafe_arena_set_allocated_recovery_module(
    ::xla::HloModuleProto* recovery_module) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.recovery_module_);
  }
  _impl_.recovery_module_ = recovery_module;
  if (recovery_module) {
...
inline ::xla::HloModuleProto* OriginalValueRecoveryTableProto_Entry::_internal_mutable_recovery_module() {
  ...
  if (_impl_.recovery_module_ == nullptr) {
    auto* p = CreateMaybeMessage<::xla::HloModuleProto>(GetArenaForAllocation());
    _impl_.recovery_module_ = p;
  }
  return _impl_.recovery_module_;
}
inline ::xla::HloModuleProto* OriginalValueRecoveryTableProto_Entry::mutable_recovery_module() {
...
inline void OriginalValueRecoveryTableProto_Entry::set_allocated_recovery_module(::xla::HloModuleProto* recovery_module) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.recovery_module_;
  }
  if (recovery_module) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(recovery_module);
    if (message_arena != submessage_arena) {
      recovery_module = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, recovery_module, submessage_arena);
    }
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::OriginalValueRecoveryTableProto_Entry >*
OriginalValueRecoveryTableProto::mutable_entries() {
  // @@protoc_insertion_point(field_mutable_list:xla.OriginalValueRecoveryTableProto.entries)
  return &_impl_.entries_;
}
inline const ::xla::OriginalValueRecoveryTableProto_Entry& OriginalValueRecoveryTableProto::_internal_entries(int index) const {
  return _impl_.entries_.Get(index);
}
...
inline ::xla::OriginalValueRecoveryTableProto_Entry* OriginalValueRecoveryTableProto::_internal_add_entries() {
  return _impl_.entries_.Add();
}
inline ::xla::OriginalValueRecoveryTableProto_Entry* OriginalValueRecoveryTableProto::add_entries() {
  ::xla::OriginalValueRecoveryTableProto_Entry* _add = _internal_add_entries();
  // @@protoc_insertion_point(field_add:xla.OriginalValueRecoveryTableProto.entries)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::OriginalValueRecoveryTableProto_Entry >&
OriginalValueRecoveryTableProto::entries() const {
