...
class AutotuneResult_BackendConfigKey;
struct AutotuneResult_BackendConfigKeyDefaultTypeInternal;
extern AutotuneResult_BackendConfigKeyDefaultTypeInternal _AutotuneResult_BackendConfigKey_default_instance_;
...
extern AutotuneResult_CustomKernelFusionKeyDefaultTypeInternal _AutotuneResult_CustomKernelFusionKey_default_instance_;
...
template<> ::xla::AutotuneResult_BackendConfigKey* Arena::CreateMaybeMessage<::xla::AutotuneResult_BackendConfigKey>(Arena*);
...
template<> ::xla::AutotuneResult_CustomKernelFusionKey* Arena::CreateMaybeMessage<::xla::AutotuneResult_CustomKernelFusionKey>(Arena*);
...
class AutotuneResult_TritonGemmKey final :
 ...
 public:
  ...
  enum : int {
    ...
    kIsWarpSpecializationAllowedFieldNumber = 9,
  };
  // int64 block_m = 1;
  void clear_block_m();
  ...
  void clear_is_warp_specialization_allowed();
  bool is_warp_specialization_allowed() const;
  void set_is_warp_specialization_allowed(bool value);
  private:
  bool _internal_is_warp_specialization_allowed() const;
  void _internal_set_is_warp_specialization_allowed(bool value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    bool is_warp_specialization_allowed_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_xla_2fautotuning_2eproto;
...
class AutotuneResult_CustomKernelFusionKey final :
...
class AutotuneResult_BackendConfigKey final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.AutotuneResult.BackendConfigKey) */ {
 public:
  inline AutotuneResult_BackendConfigKey() : AutotuneResult_BackendConfigKey(nullptr) {}
  ~AutotuneResult_BackendConfigKey() override;
  explicit PROTOBUF_CONSTEXPR AutotuneResult_BackendConfigKey(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AutotuneResult_BackendConfigKey(const AutotuneResult_BackendConfigKey& from);
  AutotuneResult_BackendConfigKey(AutotuneResult_BackendConfigKey&& from) noexcept
    : AutotuneResult_BackendConfigKey() {
    *this = ::std::move(from);
  }

  inline AutotuneResult_BackendConfigKey& operator=(const AutotuneResult_BackendConfigKey& from) {
    CopyFrom(from);
    return *this;
  }
  inline AutotuneResult_BackendConfigKey& operator=(AutotuneResult_BackendConfigKey&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const AutotuneResult_BackendConfigKey& default_instance() {
    return *internal_default_instance();
  }
  static inline const AutotuneResult_BackendConfigKey* internal_default_instance() {
    return reinterpret_cast<const AutotuneResult_BackendConfigKey*>(
               &_AutotuneResult_BackendConfigKey_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    8;

  friend void swap(AutotuneResult_BackendConfigKey& a, AutotuneResult_BackendConfigKey& b) {
    a.Swap(&b);
  }
  inline void Swap(AutotuneResult_BackendConfigKey* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(AutotuneResult_BackendConfigKey* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  AutotuneResult_BackendConfigKey* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<AutotuneResult_BackendConfigKey>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const AutotuneResult_BackendConfigKey& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const AutotuneResult_BackendConfigKey& from) {
    AutotuneResult_BackendConfigKey::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AutotuneResult_BackendConfigKey* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.AutotuneResult.BackendConfigKey";
  }
  protected:
  explicit AutotuneResult_BackendConfigKey(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:xla.AutotuneResult.BackendConfigKey)
 private:
  class _Internal;
...
class AutotuneResult final :
 ...
 public:
  ...
  typedef AutotuneResult_BackendConfigKey BackendConfigKey;
  ...
  public:
  void clear_other();
  const ::xla::AutotuneResult_BackendConfigKey& other() const;
  PROTOBUF_NODISCARD ::xla::AutotuneResult_BackendConfigKey* release_other();
  ::xla::AutotuneResult_BackendConfigKey* mutable_other();
  void set_allocated_other(::xla::AutotuneResult_BackendConfigKey* other);
  private:
  const ::xla::AutotuneResult_BackendConfigKey& _internal_other() const;
  ::xla::AutotuneResult_BackendConfigKey* _internal_mutable_other();
  public:
  void unsafe_arena_set_allocated_other(
      ::xla::AutotuneResult_BackendConfigKey* other);
  ::xla::AutotuneResult_BackendConfigKey* unsafe_arena_release_other();
 ...
 private:
  ...
  struct Impl_ {
    ...
    union KeyUnion {
      ...
      ::xla::AutotuneResult_BackendConfigKey* other_;
    } key_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    uint32_t _oneof_case_[1];
...
class AutotuningLog final :
 ...
 public:
  ...
  void clear_selected_backend();
  const std::string& selected_backend() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_selected_backend(ArgT0&& arg0, ArgT... args);
  std::string* mutable_selected_backend();
  PROTOBUF_NODISCARD std::string* release_selected_backend();
  void set_allocated_selected_backend(std::string* selected_backend);
  private:
  const std::string& _internal_selected_backend() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_selected_backend(const std::string& value);
  std::string* _internal_mutable_selected_backend();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr selected_backend_;
...
// bool is_warp_specialization_allowed = 9;
inline void AutotuneResult_TritonGemmKey::clear_is_warp_specialization_allowed() {
  _impl_.is_warp_specialization_allowed_ = false;
}
inline bool AutotuneResult_TritonGemmKey::_internal_is_warp_specialization_allowed() const {
  return _impl_.is_warp_specialization_allowed_;
}
inline bool AutotuneResult_TritonGemmKey::is_warp_specialization_allowed() const {
  // @@protoc_insertion_point(field_get:xla.AutotuneResult.TritonGemmKey.is_warp_specialization_allowed)
  return _internal_is_warp_specialization_allowed();
}
inline void AutotuneResult_TritonGemmKey::_internal_set_is_warp_specialization_allowed(bool value) {
  
  _impl_.is_warp_specialization_allowed_ = value;
}
inline void AutotuneResult_TritonGemmKey::set_is_warp_specialization_allowed(bool value) {
  _internal_set_is_warp_specialization_allowed(value);
  // @@protoc_insertion_point(field_set:xla.AutotuneResult.TritonGemmKey.is_warp_specialization_allowed)
}
...
// string name = 1;
inline void AutotuneResult_BackendConfigKey::clear_name() {
  _impl_.name_.ClearToEmpty();
}
inline const std::string& AutotuneResult_BackendConfigKey::name() const {
  // @@protoc_insertion_point(field_get:xla.AutotuneResult.BackendConfigKey.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AutotuneResult_BackendConfigKey::set_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:xla.AutotuneResult.BackendConfigKey.name)
}
inline std::string* AutotuneResult_BackendConfigKey::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:xla.AutotuneResult.BackendConfigKey.name)
  return _s;
}
inline const std::string& AutotuneResult_BackendConfigKey::_internal_name() const {
  return _impl_.name_.Get();
}
inline void AutotuneResult_BackendConfigKey::_internal_set_name(const std::string& value) {
  
  _impl_.name_.Set(value, GetArenaForAllocation());
}
inline std::string* AutotuneResult_BackendConfigKey::_internal_mutable_name() {
  
  return _impl_.name_.Mutable(GetArenaForAllocation());
}
inline std::string* AutotuneResult_BackendConfigKey::release_name() {
  // @@protoc_insertion_point(field_release:xla.AutotuneResult.BackendConfigKey.name)
  return _impl_.name_.Release();
}
inline void AutotuneResult_BackendConfigKey::set_allocated_name(std::string* name) {
  if (name != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xla.AutotuneResult.BackendConfigKey.name)
}

// .google.protobuf.Any config = 2;
inline bool AutotuneResult_BackendConfigKey::_internal_has_config() const {
  return this != internal_default_instance() && _impl_.config_ != nullptr;
}
inline bool AutotuneResult_BackendConfigKey::has_config() const {
  return _internal_has_config();
}
inline const ::PROTOBUF_NAMESPACE_ID::Any& AutotuneResult_BackendConfigKey::_internal_config() const {
  const ::PROTOBUF_NAMESPACE_ID::Any* p = _impl_.config_;
  return p != nullptr ? *p : reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Any&>(
      ::PROTOBUF_NAMESPACE_ID::_Any_default_instance_);
}
inline const ::PROTOBUF_NAMESPACE_ID::Any& AutotuneResult_BackendConfigKey::config() const {
  // @@protoc_insertion_point(field_get:xla.AutotuneResult.BackendConfigKey.config)
  return _internal_config();
}
inline void AutotuneResult_BackendConfigKey::unsafe_arena_set_allocated_config(
    ::PROTOBUF_NAMESPACE_ID::Any* config) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xla.AutotuneResult.BackendConfigKey.config)
}
inline ::PROTOBUF_NAMESPACE_ID::Any* AutotuneResult_BackendConfigKey::release_config() {
...
inline ::PROTOBUF_NAMESPACE_ID::Any* AutotuneResult_BackendConfigKey::unsafe_arena_release_config() {
  // @@protoc_insertion_point(field_release:xla.AutotuneResult.BackendConfigKey.config)
  
  ::PROTOBUF_NAMESPACE_ID::Any* temp = _impl_.config_;
  _impl_.config_ = nullptr;
  return temp;
}
inline ::PROTOBUF_NAMESPACE_ID::Any* AutotuneResult_BackendConfigKey::_internal_mutable_config() {
...
inline ::PROTOBUF_NAMESPACE_ID::Any* AutotuneResult_BackendConfigKey::mutable_config() {
  ::PROTOBUF_NAMESPACE_ID::Any* _msg = _internal_mutable_config();
  // @@protoc_insertion_point(field_mutable:xla.AutotuneResult.BackendConfigKey.config)
  return _msg;
}
inline void AutotuneResult_BackendConfigKey::set_allocated_config(::PROTOBUF_NAMESPACE_ID::Any* config) {
  ...
  _impl_.config_ = config;
  // @@protoc_insertion_point(field_set_allocated:xla.AutotuneResult.BackendConfigKey.config)
}
...
// .xla.AutotuneResult.BackendConfigKey other = 19;
inline bool AutotuneResult::_internal_has_other() const {
  return key_case() == kOther;
}
inline bool AutotuneResult::has_other() const {
  return _internal_has_other();
}
inline void AutotuneResult::set_has_other() {
  _impl_._oneof_case_[0] = kOther;
}
inline void AutotuneResult::clear_other() {
...
inline ::xla::AutotuneResult_BackendConfigKey* AutotuneResult::release_other() {
  // @@protoc_insertion_point(field_release:xla.AutotuneResult.other)
  if (_internal_has_other()) {
    clear_has_key();
    ::xla::AutotuneResult_BackendConfigKey* temp = _impl_.key_.other_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.key_.other_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::xla::AutotuneResult_BackendConfigKey& AutotuneResult::_internal_other() const {
  return _internal_has_other()
      ? *_impl_.key_.other_
      : reinterpret_cast< ::xla::AutotuneResult_BackendConfigKey&>(::xla::_AutotuneResult_BackendConfigKey_default_instance_);
}
inline const ::xla::AutotuneResult_BackendConfigKey& AutotuneResult::other() const {
  // @@protoc_insertion_point(field_get:xla.AutotuneResult.other)
  return _internal_other();
}
inline ::xla::AutotuneResult_BackendConfigKey* AutotuneResult::unsafe_arena_release_other() {
  // @@protoc_insertion_point(field_unsafe_arena_release:xla.AutotuneResult.other)
  if (_internal_has_other()) {
    clear_has_key();
    ::xla::AutotuneResult_BackendConfigKey* temp = _impl_.key_.other_;
    _impl_.key_.other_ = nullptr;
...
inline void AutotuneResult::unsafe_arena_set_allocated_other(::xla::AutotuneResult_BackendConfigKey* other) {
  clear_key();
  if (other) {
    set_has_other();
    _impl_.key_.other_ = other;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xla.AutotuneResult.other)
}
inline ::xla::AutotuneResult_BackendConfigKey* AutotuneResult::_internal_mutable_other() {
  if (!_internal_has_other()) {
    clear_key();
    set_has_other();
    _impl_.key_.other_ = CreateMaybeMessage< ::xla::AutotuneResult_BackendConfigKey >(GetArenaForAllocation());
  }
  return _impl_.key_.other_;
}
inline ::xla::AutotuneResult_BackendConfigKey* AutotuneResult::mutable_other() {
  ::xla::AutotuneResult_BackendConfigKey* _msg = _internal_mutable_other();
  // @@protoc_insertion_point(field_mutable:xla.AutotuneResult.other)
  return _msg;
}
...
// string selected_backend = 9;
inline void AutotuningLog::clear_selected_backend() {
  _impl_.selected_backend_.ClearToEmpty();
}
inline const std::string& AutotuningLog::selected_backend() const {
  // @@protoc_insertion_point(field_get:xla.AutotuningLog.selected_backend)
  return _internal_selected_backend();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AutotuningLog::set_selected_backend(ArgT0&& arg0, ArgT... args) {
 
 _impl_.selected_backend_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:xla.AutotuningLog.selected_backend)
}
inline std::string* AutotuningLog::mutable_selected_backend() {
  std::string* _s = _internal_mutable_selected_backend();
  // @@protoc_insertion_point(field_mutable:xla.AutotuningLog.selected_backend)
  return _s;
}
inline const std::string& AutotuningLog::_internal_selected_backend() const {
  return _impl_.selected_backend_.Get();
}
inline void AutotuningLog::_internal_set_selected_backend(const std::string& value) {
  
  _impl_.selected_backend_.Set(value, GetArenaForAllocation());
}
inline std::string* AutotuningLog::_internal_mutable_selected_backend() {
  
  return _impl_.selected_backend_.Mutable(GetArenaForAllocation());
}
inline std::string* AutotuningLog::release_selected_backend() {
  // @@protoc_insertion_point(field_release:xla.AutotuningLog.selected_backend)
  return _impl_.selected_backend_.Release();
}
inline void AutotuningLog::set_allocated_selected_backend(std::string* selected_backend) {
  if (selected_backend != nullptr) {
    
  } else {
    
  }
  _impl_.selected_backend_.SetAllocated(selected_backend, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.selected_backend_.IsDefault()) {
    _impl_.selected_backend_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xla.AutotuningLog.selected_backend)
}
