...
class AlgorithmProto final :
 ...
 public:
  ...
  PROTOBUF_DEPRECATED void clear_is_cudnn_frontend();
  PROTOBUF_DEPRECATED bool is_cudnn_frontend() const;
  PROTOBUF_DEPRECATED void set_is_cudnn_frontend(bool value);
  private:
