...
extern AxisRefProtoDefaultTypeInternal _AxisRefProto_default_instance_;
class AxisRefProto_SubAxis;
struct AxisRefProto_SubAxisDefaultTypeInternal;
extern AxisRefProto_SubAxisDefaultTypeInternal _AxisRefProto_SubAxis_default_instance_;
class ChannelHandle;
...
extern GemmPerfTableDefaultTypeInternal _GemmPerfTable_default_instance_;
class GemmPerfTableEntry;
struct GemmPerfTableEntryDefaultTypeInternal;
extern GemmPerfTableEntryDefaultTypeInternal _GemmPerfTableEntry_default_instance_;
class GemmPerfTableEntryValues;
struct GemmPerfTableEntryValuesDefaultTypeInternal;
extern GemmPerfTableEntryValuesDefaultTypeInternal _GemmPerfTableEntryValues_default_instance_;
class GemmPerfTableEntry_FlopsEntry_DoNotUse;
struct GemmPerfTableEntry_FlopsEntry_DoNotUseDefaultTypeInternal;
extern GemmPerfTableEntry_FlopsEntry_DoNotUseDefaultTypeInternal _GemmPerfTableEntry_FlopsEntry_DoNotUse_default_instance_;
class GemmPerfTable_EntriesEntry_DoNotUse;
struct GemmPerfTable_EntriesEntry_DoNotUseDefaultTypeInternal;
extern GemmPerfTable_EntriesEntry_DoNotUseDefaultTypeInternal _GemmPerfTable_EntriesEntry_DoNotUse_default_instance_;
...
class MeshAxesReplicaGroupListProto;
struct MeshAxesReplicaGroupListProtoDefaultTypeInternal;
extern MeshAxesReplicaGroupListProtoDefaultTypeInternal _MeshAxesReplicaGroupListProto_default_instance_;
class MeshProto;
struct MeshProtoDefaultTypeInternal;
extern MeshProtoDefaultTypeInternal _MeshProto_default_instance_;
class MeshProto_MeshAxis;
struct MeshProto_MeshAxisDefaultTypeInternal;
extern MeshProto_MeshAxisDefaultTypeInternal _MeshProto_MeshAxis_default_instance_;
class NamedShardingProto;
struct NamedShardingProtoDefaultTypeInternal;
extern NamedShardingProtoDefaultTypeInternal _NamedShardingProto_default_instance_;
class NamedShardingProto_DimensionSharding;
struct NamedShardingProto_DimensionShardingDefaultTypeInternal;
extern NamedShardingProto_DimensionShardingDefaultTypeInternal _NamedShardingProto_DimensionSharding_default_instance_;
class OpMetadata;
...
class OriginalValueElementProto;
struct OriginalValueElementProtoDefaultTypeInternal;
extern OriginalValueElementProtoDefaultTypeInternal _OriginalValueElementProto_default_instance_;
...
extern WhileLoopBackendConfig_KnownInductionVariableDefaultTypeInternal _WhileLoopBackendConfig_KnownInductionVariable_default_instance_;
class WhileLoopBackendConfig_KnownInitStep;
struct WhileLoopBackendConfig_KnownInitStepDefaultTypeInternal;
extern WhileLoopBackendConfig_KnownInitStepDefaultTypeInternal _WhileLoopBackendConfig_KnownInitStep_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::xla::AxisRefProto* Arena::CreateMaybeMessage<::xla::AxisRefProto>(Arena*);
template<> ::xla::AxisRefProto_SubAxis* Arena::CreateMaybeMessage<::xla::AxisRefProto_SubAxis>(Arena*);
...
template<> ::xla::GemmPerfTable* Arena::CreateMaybeMessage<::xla::GemmPerfTable>(Arena*);
template<> ::xla::GemmPerfTableEntry* Arena::CreateMaybeMessage<::xla::GemmPerfTableEntry>(Arena*);
template<> ::xla::GemmPerfTableEntryValues* Arena::CreateMaybeMessage<::xla::GemmPerfTableEntryValues>(Arena*);
template<> ::xla::GemmPerfTableEntry_FlopsEntry_DoNotUse* Arena::CreateMaybeMessage<::xla::GemmPerfTableEntry_FlopsEntry_DoNotUse>(Arena*);
template<> ::xla::GemmPerfTable_EntriesEntry_DoNotUse* Arena::CreateMaybeMessage<::xla::GemmPerfTable_EntriesEntry_DoNotUse>(Arena*);
...
template<> ::xla::MeshAxesReplicaGroupListProto* Arena::CreateMaybeMessage<::xla::MeshAxesReplicaGroupListProto>(Arena*);
template<> ::xla::MeshProto* Arena::CreateMaybeMessage<::xla::MeshProto>(Arena*);
template<> ::xla::MeshProto_MeshAxis* Arena::CreateMaybeMessage<::xla::MeshProto_MeshAxis>(Arena*);
template<> ::xla::NamedShardingProto* Arena::CreateMaybeMessage<::xla::NamedShardingProto>(Arena*);
template<> ::xla::NamedShardingProto_DimensionSharding* Arena::CreateMaybeMessage<::xla::NamedShardingProto_DimensionSharding>(Arena*);
...
template<> ::xla::OriginalValueElementProto* Arena::CreateMaybeMessage<::xla::OriginalValueElementProto>(Arena*);
...
template<> ::xla::WhileLoopBackendConfig_KnownInductionVariable* Arena::CreateMaybeMessage<::xla::WhileLoopBackendConfig_KnownInductionVariable>(Arena*);
template<> ::xla::WhileLoopBackendConfig_KnownInitStep* Arena::CreateMaybeMessage<::xla::WhileLoopBackendConfig_KnownInitStep>(Arena*);
...
constexpr OpSharding_Type OpSharding_Type_Type_MAX = OpSharding_Type_UNREDUCED;
...
constexpr PrecisionConfig_Algorithm PrecisionConfig_Algorithm_Algorithm_MAX = PrecisionConfig_Algorithm_ALG_DOT_BF16_BF16_F32_X9;
...
constexpr PrimitiveType PrimitiveType_MAX = BUFFER;
...
enum AsyncStreamKind : int {
  ASYNC_STREAM_KIND_COLLECTIVE = 0,
  ASYNC_STREAM_KIND_P2P0 = 1,
  ASYNC_STREAM_KIND_P2P1 = 2,
  ASYNC_STREAM_KIND_MEMCPYP2P = 3,
  AsyncStreamKind_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  AsyncStreamKind_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool AsyncStreamKind_IsValid(int value);
constexpr AsyncStreamKind AsyncStreamKind_MIN = ASYNC_STREAM_KIND_COLLECTIVE;
constexpr AsyncStreamKind AsyncStreamKind_MAX = ASYNC_STREAM_KIND_MEMCPYP2P;
constexpr int AsyncStreamKind_ARRAYSIZE = AsyncStreamKind_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* AsyncStreamKind_descriptor();
template<typename T>
inline const std::string& AsyncStreamKind_Name(T enum_t_value) {
  static_assert(::std::is_same<T, AsyncStreamKind>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function AsyncStreamKind_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    AsyncStreamKind_descriptor(), enum_t_value);
}
inline bool AsyncStreamKind_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, AsyncStreamKind* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<AsyncStreamKind>(
    AsyncStreamKind_descriptor(), name, value);
}
enum CollectiveOpGroupMode : int {
  ...
  CollectiveOpGroupMode_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  CollectiveOpGroupMode_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool CollectiveOpGroupMode_IsValid(int value);
constexpr CollectiveOpGroupMode CollectiveOpGroupMode_MIN = COLLECTIVE_OP_GROUP_MODE_CROSS_REPLICA;
constexpr CollectiveOpGroupMode CollectiveOpGroupMode_MAX = COLLECTIVE_OP_GROUP_MODE_FLATTENED_ID;
constexpr int CollectiveOpGroupMode_ARRAYSIZE = CollectiveOpGroupMode_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* CollectiveOpGroupMode_descriptor();
template<typename T>
inline const std::string& CollectiveOpGroupMode_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CollectiveOpGroupMode>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CollectiveOpGroupMode_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    CollectiveOpGroupMode_descriptor(), enum_t_value);
}
inline bool CollectiveOpGroupMode_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, CollectiveOpGroupMode* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<CollectiveOpGroupMode>(
    CollectiveOpGroupMode_descriptor(), name, value);
}
...
enum ProfileGenerationStrategy : int {
  ...
  ProfileGenerationStrategy_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ProfileGenerationStrategy_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool ProfileGenerationStrategy_IsValid(int value);
constexpr ProfileGenerationStrategy ProfileGenerationStrategy_MIN = PROFILE_GENERATION_STRATEGY_UNKNOWN;
constexpr ProfileGenerationStrategy ProfileGenerationStrategy_MAX = PROFILE_GENERATION_STRATEGY_LCM_MOE;
constexpr int ProfileGenerationStrategy_ARRAYSIZE = ProfileGenerationStrategy_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ProfileGenerationStrategy_descriptor();
template<typename T>
inline const std::string& ProfileGenerationStrategy_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ProfileGenerationStrategy_descriptor(), enum_t_value);
}
inline bool ProfileGenerationStrategy_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ProfileGenerationStrategy* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ProfileGenerationStrategy>(
    ProfileGenerationStrategy_descriptor(), name, value);
}
...
class OpMetadata_ProfileInfo final :
 ...
 public:
  ...
  enum : int {
    ...
    kProfileGenerationStrategyFieldNumber = 5,
  };
  ...
  ::xla::ProfileGenerationStrategy profile_generation_strategy() const;
  void set_profile_generation_strategy(::xla::ProfileGenerationStrategy value);
  private:
  ::xla::ProfileGenerationStrategy _internal_profile_generation_strategy() const;
  void _internal_set_profile_generation_strategy(::xla::ProfileGenerationStrategy value);
  public:
...
class OpMetadata final :
 ...
 public:
  ...
  enum : int {
    ...
    kSourceEndLineFieldNumber = 17,
    kSourceColumnFieldNumber = 18,
    kSourceEndColumnFieldNumber = 19,
  };
  ...
  void clear_source_end_line();
  int32_t source_end_line() const;
  void set_source_end_line(int32_t value);
  private:
  int32_t _internal_source_end_line() const;
  void _internal_set_source_end_line(int32_t value);
  public:

  // int32 source_column = 18;
  void clear_source_column();
  int32_t source_column() const;
  void set_source_column(int32_t value);
  private:
  int32_t _internal_source_column() const;
  void _internal_set_source_column(int32_t value);
  public:

  // int32 source_end_column = 19;
  void clear_source_end_column();
  int32_t source_end_column() const;
  void set_source_end_column(int32_t value);
  private:
  int32_t _internal_source_end_column() const;
  void _internal_set_source_end_column(int32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    int32_t source_end_line_;
    int32_t source_column_;
    int32_t source_end_column_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_xla_2fxla_5fdata_2eproto;
...
class MeshProto_MeshAxis final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.MeshProto.MeshAxis) */ {
 public:
  inline MeshProto_MeshAxis() : MeshProto_MeshAxis(nullptr) {}
  ~MeshProto_MeshAxis() override;
  explicit PROTOBUF_CONSTEXPR MeshProto_MeshAxis(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  MeshProto_MeshAxis(const MeshProto_MeshAxis& from);
  MeshProto_MeshAxis(MeshProto_MeshAxis&& from) noexcept
    : MeshProto_MeshAxis() {
    *this = ::std::move(from);
  }

  inline MeshProto_MeshAxis& operator=(const MeshProto_MeshAxis& from) {
    CopyFrom(from);
    return *this;
  }
  inline MeshProto_MeshAxis& operator=(MeshProto_MeshAxis&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const MeshProto_MeshAxis& default_instance() {
    return *internal_default_instance();
  }
  static inline const MeshProto_MeshAxis* internal_default_instance() {
    return reinterpret_cast<const MeshProto_MeshAxis*>(
               &_MeshProto_MeshAxis_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    32;

  friend void swap(MeshProto_MeshAxis& a, MeshProto_MeshAxis& b) {
    a.Swap(&b);
  }
  inline void Swap(MeshProto_MeshAxis* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(MeshProto_MeshAxis* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  MeshProto_MeshAxis* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<MeshProto_MeshAxis>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const MeshProto_MeshAxis& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const MeshProto_MeshAxis& from) {
    MeshProto_MeshAxis::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(MeshProto_MeshAxis* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.MeshProto.MeshAxis";
  }
  protected:
  explicit MeshProto_MeshAxis(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:xla.MeshProto.MeshAxis)
 private:
  class _Internal;
...
class MeshProto final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.MeshProto) */ {
 public:
  inline MeshProto() : MeshProto(nullptr) {}
  ~MeshProto() override;
  explicit PROTOBUF_CONSTEXPR MeshProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline void Swap(MeshProto* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(MeshProto* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  MeshProto* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.MeshProto";
  }
  protected:
  explicit MeshProto(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  typedef MeshProto_MeshAxis MeshAxis;
  ...
  public:
  void clear_axes();
  ::xla::MeshProto_MeshAxis* mutable_axes(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::MeshProto_MeshAxis >*
      mutable_axes();
  private:
  const ::xla::MeshProto_MeshAxis& _internal_axes(int index) const;
  ::xla::MeshProto_MeshAxis* _internal_add_axes();
  public:
  const ::xla::MeshProto_MeshAxis& axes(int index) const;
  ::xla::MeshProto_MeshAxis* add_axes();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::MeshProto_MeshAxis >&
      axes() const;
  ...
  private:
  int64_t _internal_device_ids(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
      _internal_device_ids() const;
  void _internal_add_device_ids(int64_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
      _internal_mutable_device_ids();
  public:
  int64_t device_ids(int index) const;
  void set_device_ids(int index, int64_t value);
  void add_device_ids(int64_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
      device_ids() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
      mutable_device_ids();

  // @@protoc_insertion_point(class_scope:xla.MeshProto)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::MeshProto_MeshAxis > axes_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t > device_ids_;
...
class AxisRefProto_SubAxis final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.AxisRefProto.SubAxis) */ {
 public:
  inline AxisRefProto_SubAxis() : AxisRefProto_SubAxis(nullptr) {}
  ~AxisRefProto_SubAxis() override;
  explicit PROTOBUF_CONSTEXPR AxisRefProto_SubAxis(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AxisRefProto_SubAxis(const AxisRefProto_SubAxis& from);
  AxisRefProto_SubAxis(AxisRefProto_SubAxis&& from) noexcept
    : AxisRefProto_SubAxis() {
    *this = ::std::move(from);
  }

  inline AxisRefProto_SubAxis& operator=(const AxisRefProto_SubAxis& from) {
    CopyFrom(from);
    return *this;
  }
  inline AxisRefProto_SubAxis& operator=(AxisRefProto_SubAxis&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const AxisRefProto_SubAxis& default_instance() {
    return *internal_default_instance();
  }
  static inline const AxisRefProto_SubAxis* internal_default_instance() {
    return reinterpret_cast<const AxisRefProto_SubAxis*>(
               &_AxisRefProto_SubAxis_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    34;

  friend void swap(AxisRefProto_SubAxis& a, AxisRefProto_SubAxis& b) {
    a.Swap(&b);
  }
  inline void Swap(AxisRefProto_SubAxis* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(AxisRefProto_SubAxis* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  AxisRefProto_SubAxis* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<AxisRefProto_SubAxis>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const AxisRefProto_SubAxis& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const AxisRefProto_SubAxis& from) {
    AxisRefProto_SubAxis::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AxisRefProto_SubAxis* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.AxisRefProto.SubAxis";
  }
  protected:
  explicit AxisRefProto_SubAxis(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kPreSizeFieldNumber = 1,
    kSizeFieldNumber = 2,
  };
  // int64 pre_size = 1;
  void clear_pre_size();
  int64_t pre_size() const;
  void set_pre_size(int64_t value);
  private:
  int64_t _internal_pre_size() const;
  void _internal_set_pre_size(int64_t value);
  public:
  ...
  // @@protoc_insertion_point(class_scope:xla.AxisRefProto.SubAxis)
 private:
  class _Internal;
...
class AxisRefProto final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.AxisRefProto) */ {
 public:
  inline AxisRefProto() : AxisRefProto(nullptr) {}
  ~AxisRefProto() override;
  explicit PROTOBUF_CONSTEXPR AxisRefProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AxisRefProto(const AxisRefProto& from);
  AxisRefProto(AxisRefProto&& from) noexcept
    : AxisRefProto() {
    *this = ::std::move(from);
  }

  inline AxisRefProto& operator=(const AxisRefProto& from) {
    CopyFrom(from);
    return *this;
  }
  inline AxisRefProto& operator=(AxisRefProto&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const AxisRefProto& default_instance() {
    return *internal_default_instance();
  }
  static inline const AxisRefProto* internal_default_instance() {
    return reinterpret_cast<const AxisRefProto*>(
               &_AxisRefProto_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    35;

  friend void swap(AxisRefProto& a, AxisRefProto& b) {
    a.Swap(&b);
  }
  inline void Swap(AxisRefProto* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(AxisRefProto* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  AxisRefProto* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<AxisRefProto>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const AxisRefProto& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const AxisRefProto& from) {
    AxisRefProto::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AxisRefProto* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.AxisRefProto";
  }
  protected:
  explicit AxisRefProto(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  typedef AxisRefProto_SubAxis SubAxis;

  // accessors -------------------------------------------------------

  enum : int {
    kSubAxisInfoFieldNumber = 2,
    kMeshAxisIndexFieldNumber = 1,
  };
  // optional .xla.AxisRefProto.SubAxis sub_axis_info = 2;
  bool has_sub_axis_info() const;
  private:
  bool _internal_has_sub_axis_info() const;
  public:
  void clear_sub_axis_info();
  const ::xla::AxisRefProto_SubAxis& sub_axis_info() const;
  PROTOBUF_NODISCARD ::xla::AxisRefProto_SubAxis* release_sub_axis_info();
  ::xla::AxisRefProto_SubAxis* mutable_sub_axis_info();
  void set_allocated_sub_axis_info(::xla::AxisRefProto_SubAxis* sub_axis_info);
  private:
  const ::xla::AxisRefProto_SubAxis& _internal_sub_axis_info() const;
  ::xla::AxisRefProto_SubAxis* _internal_mutable_sub_axis_info();
  public:
  void unsafe_arena_set_allocated_sub_axis_info(
      ::xla::AxisRefProto_SubAxis* sub_axis_info);
  ::xla::AxisRefProto_SubAxis* unsafe_arena_release_sub_axis_info();

  // int64 mesh_axis_index = 1;
  void clear_mesh_axis_index();
  int64_t mesh_axis_index() const;
  void set_mesh_axis_index(int64_t value);
  private:
  int64_t _internal_mesh_axis_index() const;
  void _internal_set_mesh_axis_index(int64_t value);
  public:

  // @@protoc_insertion_point(class_scope:xla.AxisRefProto)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ...
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::xla::AxisRefProto_SubAxis* sub_axis_info_;
...
class NamedShardingProto_DimensionSharding final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.NamedShardingProto.DimensionSharding) */ {
 public:
  inline NamedShardingProto_DimensionSharding() : NamedShardingProto_DimensionSharding(nullptr) {}
  ~NamedShardingProto_DimensionSharding() override;
  explicit PROTOBUF_CONSTEXPR NamedShardingProto_DimensionSharding(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  NamedShardingProto_DimensionSharding(const NamedShardingProto_DimensionSharding& from);
  NamedShardingProto_DimensionSharding(NamedShardingProto_DimensionSharding&& from) noexcept
    : NamedShardingProto_DimensionSharding() {
    *this = ::std::move(from);
  }

  inline NamedShardingProto_DimensionSharding& operator=(const NamedShardingProto_DimensionSharding& from) {
    CopyFrom(from);
    return *this;
  }
  inline NamedShardingProto_DimensionSharding& operator=(NamedShardingProto_DimensionSharding&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const NamedShardingProto_DimensionSharding& default_instance() {
    return *internal_default_instance();
  }
  static inline const NamedShardingProto_DimensionSharding* internal_default_instance() {
    return reinterpret_cast<const NamedShardingProto_DimensionSharding*>(
               &_NamedShardingProto_DimensionSharding_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    36;

  friend void swap(NamedShardingProto_DimensionSharding& a, NamedShardingProto_DimensionSharding& b) {
    a.Swap(&b);
  }
  inline void Swap(NamedShardingProto_DimensionSharding* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(NamedShardingProto_DimensionSharding* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  NamedShardingProto_DimensionSharding* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<NamedShardingProto_DimensionSharding>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const NamedShardingProto_DimensionSharding& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const NamedShardingProto_DimensionSharding& from) {
    NamedShardingProto_DimensionSharding::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(NamedShardingProto_DimensionSharding* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.NamedShardingProto.DimensionSharding";
  }
  protected:
  explicit NamedShardingProto_DimensionSharding(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  public:
  void clear_axes();
  ::xla::AxisRefProto* mutable_axes(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >*
      mutable_axes();
  private:
  const ::xla::AxisRefProto& _internal_axes(int index) const;
  ::xla::AxisRefProto* _internal_add_axes();
  public:
  const ::xla::AxisRefProto& axes(int index) const;
  ::xla::AxisRefProto* add_axes();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >&
      axes() const;
  ...
  // @@protoc_insertion_point(class_scope:xla.NamedShardingProto.DimensionSharding)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto > axes_;
    bool is_closed_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
class NamedShardingProto final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.NamedShardingProto) */ {
 public:
  inline NamedShardingProto() : NamedShardingProto(nullptr) {}
  ~NamedShardingProto() override;
  explicit PROTOBUF_CONSTEXPR NamedShardingProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  NamedShardingProto(const NamedShardingProto& from);
  NamedShardingProto(NamedShardingProto&& from) noexcept
    : NamedShardingProto() {
    *this = ::std::move(from);
  }

  inline NamedShardingProto& operator=(const NamedShardingProto& from) {
    CopyFrom(from);
    return *this;
  }
  inline NamedShardingProto& operator=(NamedShardingProto&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const NamedShardingProto& default_instance() {
    return *internal_default_instance();
  }
  static inline const NamedShardingProto* internal_default_instance() {
    return reinterpret_cast<const NamedShardingProto*>(
               &_NamedShardingProto_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    37;

  friend void swap(NamedShardingProto& a, NamedShardingProto& b) {
    a.Swap(&b);
  }
  inline void Swap(NamedShardingProto* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(NamedShardingProto* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  NamedShardingProto* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<NamedShardingProto>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const NamedShardingProto& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const NamedShardingProto& from) {
    NamedShardingProto::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(NamedShardingProto* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.NamedShardingProto";
  }
  protected:
  explicit NamedShardingProto(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  typedef NamedShardingProto_DimensionSharding DimensionSharding;

  // accessors -------------------------------------------------------

  enum : int {
    kDimShardingsFieldNumber = 3,
    kReplicatedAxesFieldNumber = 4,
    kUnreducedAxesFieldNumber = 5,
    kMetadataFieldNumber = 6,
    kMeshFieldNumber = 2,
  };
  // repeated .xla.NamedShardingProto.DimensionSharding dim_shardings = 3;
  int dim_shardings_size() const;
  private:
  int _internal_dim_shardings_size() const;
  public:
  void clear_dim_shardings();
  ::xla::NamedShardingProto_DimensionSharding* mutable_dim_shardings(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::NamedShardingProto_DimensionSharding >*
      mutable_dim_shardings();
  private:
  const ::xla::NamedShardingProto_DimensionSharding& _internal_dim_shardings(int index) const;
  ::xla::NamedShardingProto_DimensionSharding* _internal_add_dim_shardings();
  public:
  const ::xla::NamedShardingProto_DimensionSharding& dim_shardings(int index) const;
  ::xla::NamedShardingProto_DimensionSharding* add_dim_shardings();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::NamedShardingProto_DimensionSharding >&
      dim_shardings() const;

  // repeated .xla.AxisRefProto replicated_axes = 4;
  int replicated_axes_size() const;
  private:
  int _internal_replicated_axes_size() const;
  public:
  void clear_replicated_axes();
  ::xla::AxisRefProto* mutable_replicated_axes(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >*
      mutable_replicated_axes();
  private:
  const ::xla::AxisRefProto& _internal_replicated_axes(int index) const;
  ::xla::AxisRefProto* _internal_add_replicated_axes();
  public:
  const ::xla::AxisRefProto& replicated_axes(int index) const;
  ::xla::AxisRefProto* add_replicated_axes();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >&
      replicated_axes() const;

  // repeated .xla.AxisRefProto unreduced_axes = 5;
  int unreduced_axes_size() const;
  private:
  int _internal_unreduced_axes_size() const;
  public:
  void clear_unreduced_axes();
  ::xla::AxisRefProto* mutable_unreduced_axes(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >*
      mutable_unreduced_axes();
  private:
  const ::xla::AxisRefProto& _internal_unreduced_axes(int index) const;
  ::xla::AxisRefProto* _internal_add_unreduced_axes();
  public:
  const ::xla::AxisRefProto& unreduced_axes(int index) const;
  ::xla::AxisRefProto* add_unreduced_axes();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >&
      unreduced_axes() const;
  ...
  public:
  void clear_mesh();
  const ::xla::MeshProto& mesh() const;
  PROTOBUF_NODISCARD ::xla::MeshProto* release_mesh();
  ::xla::MeshProto* mutable_mesh();
  void set_allocated_mesh(::xla::MeshProto* mesh);
  private:
  const ::xla::MeshProto& _internal_mesh() const;
  ::xla::MeshProto* _internal_mutable_mesh();
  public:
  void unsafe_arena_set_allocated_mesh(
      ::xla::MeshProto* mesh);
  ::xla::MeshProto* unsafe_arena_release_mesh();

  // @@protoc_insertion_point(class_scope:xla.NamedShardingProto)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::NamedShardingProto_DimensionSharding > dim_shardings_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto > replicated_axes_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto > unreduced_axes_;
...
class OpSharding final :
 ...
 public:
  ...
  static constexpr Type UNREDUCED =
    OpSharding_Type_UNREDUCED;
  ...
  bool has_named_sharding() const;
  private:
  bool _internal_has_named_sharding() const;
  public:
  void clear_named_sharding();
  const ::xla::NamedShardingProto& named_sharding() const;
  PROTOBUF_NODISCARD ::xla::NamedShardingProto* release_named_sharding();
  ::xla::NamedShardingProto* mutable_named_sharding();
  void set_allocated_named_sharding(::xla::NamedShardingProto* named_sharding);
  private:
  const ::xla::NamedShardingProto& _internal_named_sharding() const;
  ::xla::NamedShardingProto* _internal_mutable_named_sharding();
  public:
  void unsafe_arena_set_allocated_named_sharding(
      ::xla::NamedShardingProto* named_sharding);
  ::xla::NamedShardingProto* unsafe_arena_release_named_sharding();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::xla::NamedShardingProto* named_sharding_;
    int type_;
...
class MeshAxesReplicaGroupListProto final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.MeshAxesReplicaGroupListProto) */ {
 public:
  inline MeshAxesReplicaGroupListProto() : MeshAxesReplicaGroupListProto(nullptr) {}
  ~MeshAxesReplicaGroupListProto() override;
  explicit PROTOBUF_CONSTEXPR MeshAxesReplicaGroupListProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  MeshAxesReplicaGroupListProto(const MeshAxesReplicaGroupListProto& from);
  MeshAxesReplicaGroupListProto(MeshAxesReplicaGroupListProto&& from) noexcept
    : MeshAxesReplicaGroupListProto() {
    *this = ::std::move(from);
  }

  inline MeshAxesReplicaGroupListProto& operator=(const MeshAxesReplicaGroupListProto& from) {
    CopyFrom(from);
    return *this;
  }
  inline MeshAxesReplicaGroupListProto& operator=(MeshAxesReplicaGroupListProto&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const MeshAxesReplicaGroupListProto& default_instance() {
    return *internal_default_instance();
  }
  static inline const MeshAxesReplicaGroupListProto* internal_default_instance() {
    return reinterpret_cast<const MeshAxesReplicaGroupListProto*>(
               &_MeshAxesReplicaGroupListProto_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    40;

  friend void swap(MeshAxesReplicaGroupListProto& a, MeshAxesReplicaGroupListProto& b) {
    a.Swap(&b);
  }
  inline void Swap(MeshAxesReplicaGroupListProto* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(MeshAxesReplicaGroupListProto* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  MeshAxesReplicaGroupListProto* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<MeshAxesReplicaGroupListProto>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const MeshAxesReplicaGroupListProto& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const MeshAxesReplicaGroupListProto& from) {
    MeshAxesReplicaGroupListProto::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(MeshAxesReplicaGroupListProto* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.MeshAxesReplicaGroupListProto";
  }
  protected:
  explicit MeshAxesReplicaGroupListProto(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:xla.MeshAxesReplicaGroupListProto)
 private:
  class _Internal;
...
class PrecisionConfig final :
 ...
 public:
  ...
  static constexpr Algorithm ALG_DOT_BF16_BF16_F32_X9 =
    PrecisionConfig_Algorithm_ALG_DOT_BF16_BF16_F32_X9;
...
class WhileLoopBackendConfig_KnownInitStep final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.WhileLoopBackendConfig.KnownInitStep) */ {
 public:
  inline WhileLoopBackendConfig_KnownInitStep() : WhileLoopBackendConfig_KnownInitStep(nullptr) {}
  ~WhileLoopBackendConfig_KnownInitStep() override;
  explicit PROTOBUF_CONSTEXPR WhileLoopBackendConfig_KnownInitStep(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  WhileLoopBackendConfig_KnownInitStep(const WhileLoopBackendConfig_KnownInitStep& from);
  WhileLoopBackendConfig_KnownInitStep(WhileLoopBackendConfig_KnownInitStep&& from) noexcept
  ...
  friend void swap(WhileLoopBackendConfig_KnownInitStep& a, WhileLoopBackendConfig_KnownInitStep& b) {
    a.Swap(&b);
  }
  ...
  WhileLoopBackendConfig_KnownInitStep* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<WhileLoopBackendConfig_KnownInitStep>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const WhileLoopBackendConfig_KnownInitStep& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const WhileLoopBackendConfig_KnownInitStep& from) {
    WhileLoopBackendConfig_KnownInitStep::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.WhileLoopBackendConfig.KnownInitStep";
  }
  protected:
  explicit WhileLoopBackendConfig_KnownInitStep(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class WhileLoopBackendConfig_KnownInductionVariable final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.WhileLoopBackendConfig.KnownInductionVariable) */ {
 public:
  inline WhileLoopBackendConfig_KnownInductionVariable() : WhileLoopBackendConfig_KnownInductionVariable(nullptr) {}
  ~WhileLoopBackendConfig_KnownInductionVariable() override;
  explicit PROTOBUF_CONSTEXPR WhileLoopBackendConfig_KnownInductionVariable(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  WhileLoopBackendConfig_KnownInductionVariable(const WhileLoopBackendConfig_KnownInductionVariable& from);
  WhileLoopBackendConfig_KnownInductionVariable(WhileLoopBackendConfig_KnownInductionVariable&& from) noexcept
  ...
  friend void swap(WhileLoopBackendConfig_KnownInductionVariable& a, WhileLoopBackendConfig_KnownInductionVariable& b) {
    a.Swap(&b);
  }
  ...
  WhileLoopBackendConfig_KnownInductionVariable* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<WhileLoopBackendConfig_KnownInductionVariable>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const WhileLoopBackendConfig_KnownInductionVariable& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const WhileLoopBackendConfig_KnownInductionVariable& from) {
    WhileLoopBackendConfig_KnownInductionVariable::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.WhileLoopBackendConfig.KnownInductionVariable";
  }
  protected:
  explicit WhileLoopBackendConfig_KnownInductionVariable(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class WhileLoopBackendConfig final :
 ...
 public:
  ...
  typedef WhileLoopBackendConfig_KnownInitStep KnownInitStep;
  typedef WhileLoopBackendConfig_KnownTripCount KnownTripCount;
  typedef WhileLoopBackendConfig_KnownInductionVariable KnownInductionVariable;
  ...
  private:
  bool _internal_has_known_init_step() const;
  public:
  ...
  void set_allocated_known_init_step(::xla::WhileLoopBackendConfig_KnownInitStep* known_init_step);
  private:
  ...
  public:
  void unsafe_arena_set_allocated_known_init_step(
      ::xla::WhileLoopBackendConfig_KnownInitStep* known_init_step);
  ...
  private:
  bool _internal_has_known_induction_variable() const;
  public:
  ...
  void set_allocated_known_induction_variable(::xla::WhileLoopBackendConfig_KnownInductionVariable* known_induction_variable);
  private:
  ...
  public:
  void unsafe_arena_set_allocated_known_induction_variable(
      ::xla::WhileLoopBackendConfig_KnownInductionVariable* known_induction_variable);
...
class OriginalValueElementProto final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.OriginalValueElementProto) */ {
 public:
  inline OriginalValueElementProto() : OriginalValueElementProto(nullptr) {}
  ~OriginalValueElementProto() override;
  explicit PROTOBUF_CONSTEXPR OriginalValueElementProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  OriginalValueElementProto(const OriginalValueElementProto& from);
  OriginalValueElementProto(OriginalValueElementProto&& from) noexcept
    : OriginalValueElementProto() {
    *this = ::std::move(from);
  }

  inline OriginalValueElementProto& operator=(const OriginalValueElementProto& from) {
    CopyFrom(from);
    return *this;
  }
  inline OriginalValueElementProto& operator=(OriginalValueElementProto&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const OriginalValueElementProto& default_instance() {
    return *internal_default_instance();
  }
  static inline const OriginalValueElementProto* internal_default_instance() {
    return reinterpret_cast<const OriginalValueElementProto*>(
               &_OriginalValueElementProto_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    54;

  friend void swap(OriginalValueElementProto& a, OriginalValueElementProto& b) {
    a.Swap(&b);
  }
  inline void Swap(OriginalValueElementProto* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(OriginalValueElementProto* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  OriginalValueElementProto* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<OriginalValueElementProto>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const OriginalValueElementProto& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const OriginalValueElementProto& from) {
    OriginalValueElementProto::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(OriginalValueElementProto* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.OriginalValueElementProto";
  }
  protected:
  explicit OriginalValueElementProto(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  private:
  bool _internal_has_original_array() const;
  public:
  ...
  void set_allocated_original_array(::xla::OriginalArrayProto* original_array);
  private:
  const ::xla::OriginalArrayProto& _internal_original_array() const;
  ::xla::OriginalArrayProto* _internal_mutable_original_array();
  public:
  void unsafe_arena_set_allocated_original_array(
      ::xla::OriginalArrayProto* original_array);
  ::xla::OriginalArrayProto* unsafe_arena_release_original_array();

  // @@protoc_insertion_point(class_scope:xla.OriginalValueElementProto)
 private:
  class _Internal;
...
class OriginalValueProto final :
 ...
 public:
  ...
  public:
  void clear_elements();
  ::xla::OriginalValueElementProto* mutable_elements(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::OriginalValueElementProto >*
      mutable_elements();
  private:
  const ::xla::OriginalValueElementProto& _internal_elements(int index) const;
  ::xla::OriginalValueElementProto* _internal_add_elements();
  public:
  const ::xla::OriginalValueElementProto& elements(int index) const;
  ::xla::OriginalValueElementProto* add_elements();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::OriginalValueElementProto >&
      elements() const;

  // bool is_synthetic_call = 2;
  void clear_is_synthetic_call();
  bool is_synthetic_call() const;
  void set_is_synthetic_call(bool value);
  private:
  bool _internal_is_synthetic_call() const;
  void _internal_set_is_synthetic_call(bool value);
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::OriginalValueElementProto > elements_;
    bool is_synthetic_call_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_xla_2fxla_5fdata_2eproto;
...
class GemmPerfTableEntry_FlopsEntry_DoNotUse : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<GemmPerfTableEntry_FlopsEntry_DoNotUse, 
    std::string, int64_t,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_INT64> {
public:
  typedef ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<GemmPerfTableEntry_FlopsEntry_DoNotUse, 
    std::string, int64_t,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
  ...
  explicit PROTOBUF_CONSTEXPR GemmPerfTableEntry_FlopsEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  explicit GemmPerfTableEntry_FlopsEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  void MergeFrom(const GemmPerfTableEntry_FlopsEntry_DoNotUse& other);
  static const GemmPerfTableEntry_FlopsEntry_DoNotUse* internal_default_instance() { return reinterpret_cast<const GemmPerfTableEntry_FlopsEntry_DoNotUse*>(&_GemmPerfTableEntry_FlopsEntry_DoNotUse_default_instance_); }
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "xla.GemmPerfTableEntry.FlopsEntry.key");
 }
...
class GemmPerfTableEntry final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.GemmPerfTableEntry) */ {
 public:
  inline GemmPerfTableEntry() : GemmPerfTableEntry(nullptr) {}
  ~GemmPerfTableEntry() override;
  explicit PROTOBUF_CONSTEXPR GemmPerfTableEntry(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GemmPerfTableEntry(const GemmPerfTableEntry& from);
  GemmPerfTableEntry(GemmPerfTableEntry&& from) noexcept
    : GemmPerfTableEntry() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(GemmPerfTableEntry& a, GemmPerfTableEntry& b) {
    a.Swap(&b);
  }
  ...
  GemmPerfTableEntry* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GemmPerfTableEntry>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GemmPerfTableEntry& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GemmPerfTableEntry& from) {
    GemmPerfTableEntry::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.GemmPerfTableEntry";
  }
  protected:
  explicit GemmPerfTableEntry(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::Map< std::string, int64_t >&
      _internal_flops() const;
  ::PROTOBUF_NAMESPACE_ID::Map< std::string, int64_t >*
      _internal_mutable_flops();
  public:
  const ::PROTOBUF_NAMESPACE_ID::Map< std::string, int64_t >&
      flops() const;
  ::PROTOBUF_NAMESPACE_ID::Map< std::string, int64_t >*
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::MapField<
        ...
        std::string, int64_t,
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_INT64> flops_;
    int64_t b_;
    int64_t m_;
    int64_t n_;
    int64_t k_;
...
class GemmPerfTableEntryValues final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.GemmPerfTableEntryValues) */ {
 public:
  inline GemmPerfTableEntryValues() : GemmPerfTableEntryValues(nullptr) {}
  ~GemmPerfTableEntryValues() override;
  explicit PROTOBUF_CONSTEXPR GemmPerfTableEntryValues(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GemmPerfTableEntryValues(const GemmPerfTableEntryValues& from);
  GemmPerfTableEntryValues(GemmPerfTableEntryValues&& from) noexcept
  ...
  friend void swap(GemmPerfTableEntryValues& a, GemmPerfTableEntryValues& b) {
    a.Swap(&b);
  }
  ...
  GemmPerfTableEntryValues* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GemmPerfTableEntryValues>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GemmPerfTableEntryValues& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GemmPerfTableEntryValues& from) {
    GemmPerfTableEntryValues::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.GemmPerfTableEntryValues";
  }
  protected:
  explicit GemmPerfTableEntryValues(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::GemmPerfTableEntry >*
      mutable_entries();
  private:
  const ::xla::GemmPerfTableEntry& _internal_entries(int index) const;
  ::xla::GemmPerfTableEntry* _internal_add_entries();
  public:
  const ::xla::GemmPerfTableEntry& entries(int index) const;
  ::xla::GemmPerfTableEntry* add_entries();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::GemmPerfTableEntry >&
      entries() const;
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::GemmPerfTableEntry > entries_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_xla_2fxla_5fdata_2eproto;
...
class GemmPerfTable_EntriesEntry_DoNotUse : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<GemmPerfTable_EntriesEntry_DoNotUse, 
    std::string, ::xla::GemmPerfTableEntryValues,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_MESSAGE> {
public:
  typedef ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<GemmPerfTable_EntriesEntry_DoNotUse, 
    std::string, ::xla::GemmPerfTableEntryValues,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
  ...
  explicit PROTOBUF_CONSTEXPR GemmPerfTable_EntriesEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  explicit GemmPerfTable_EntriesEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  void MergeFrom(const GemmPerfTable_EntriesEntry_DoNotUse& other);
  static const GemmPerfTable_EntriesEntry_DoNotUse* internal_default_instance() { return reinterpret_cast<const GemmPerfTable_EntriesEntry_DoNotUse*>(&_GemmPerfTable_EntriesEntry_DoNotUse_default_instance_); }
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "xla.GemmPerfTable.EntriesEntry.key");
 }
  static bool ValidateValue(void*) { return true; }
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadata() const final;
...
class GemmPerfTable final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.GemmPerfTable) */ {
 public:
  inline GemmPerfTable() : GemmPerfTable(nullptr) {}
  ~GemmPerfTable() override;
  explicit PROTOBUF_CONSTEXPR GemmPerfTable(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GemmPerfTable(const GemmPerfTable& from);
  GemmPerfTable(GemmPerfTable&& from) noexcept
    : GemmPerfTable() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(GemmPerfTable& a, GemmPerfTable& b) {
    a.Swap(&b);
  }
  ...
  GemmPerfTable* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GemmPerfTable>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GemmPerfTable& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GemmPerfTable& from) {
    GemmPerfTable::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.GemmPerfTable";
  }
  protected:
  explicit GemmPerfTable(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  public:
  ...
  void clear_entries();
  private:
  const ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::xla::GemmPerfTableEntryValues >&
      _internal_entries() const;
  ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::xla::GemmPerfTableEntryValues >*
...
// .xla.ProfileGenerationStrategy profile_generation_strategy = 5;
inline void OpMetadata_ProfileInfo::clear_profile_generation_strategy() {
  _impl_.profile_generation_strategy_ = 0;
}
inline ::xla::ProfileGenerationStrategy OpMetadata_ProfileInfo::_internal_profile_generation_strategy() const {
  return static_cast< ::xla::ProfileGenerationStrategy >(_impl_.profile_generation_strategy_);
}
inline ::xla::ProfileGenerationStrategy OpMetadata_ProfileInfo::profile_generation_strategy() const {
  // @@protoc_insertion_point(field_get:xla.OpMetadata.ProfileInfo.profile_generation_strategy)
  return _internal_profile_generation_strategy();
}
inline void OpMetadata_ProfileInfo::_internal_set_profile_generation_strategy(::xla::ProfileGenerationStrategy value) {
  
  _impl_.profile_generation_strategy_ = value;
}
inline void OpMetadata_ProfileInfo::set_profile_generation_strategy(::xla::ProfileGenerationStrategy value) {
  _internal_set_profile_generation_strategy(value);
  // @@protoc_insertion_point(field_set:xla.OpMetadata.ProfileInfo.profile_generation_strategy)
}
...
// int32 source_end_line = 17;
inline void OpMetadata::clear_source_end_line() {
  _impl_.source_end_line_ = 0;
}
inline int32_t OpMetadata::_internal_source_end_line() const {
  return _impl_.source_end_line_;
}
inline int32_t OpMetadata::source_end_line() const {
  // @@protoc_insertion_point(field_get:xla.OpMetadata.source_end_line)
  return _internal_source_end_line();
}
inline void OpMetadata::_internal_set_source_end_line(int32_t value) {
  
  _impl_.source_end_line_ = value;
}
inline void OpMetadata::set_source_end_line(int32_t value) {
  _internal_set_source_end_line(value);
  // @@protoc_insertion_point(field_set:xla.OpMetadata.source_end_line)
}

// int32 source_column = 18;
inline void OpMetadata::clear_source_column() {
  _impl_.source_column_ = 0;
}
inline int32_t OpMetadata::_internal_source_column() const {
  return _impl_.source_column_;
}
inline int32_t OpMetadata::source_column() const {
  // @@protoc_insertion_point(field_get:xla.OpMetadata.source_column)
  return _internal_source_column();
}
inline void OpMetadata::_internal_set_source_column(int32_t value) {
  
  _impl_.source_column_ = value;
}
inline void OpMetadata::set_source_column(int32_t value) {
  _internal_set_source_column(value);
  // @@protoc_insertion_point(field_set:xla.OpMetadata.source_column)
}

// int32 source_end_column = 19;
inline void OpMetadata::clear_source_end_column() {
  _impl_.source_end_column_ = 0;
}
inline int32_t OpMetadata::_internal_source_end_column() const {
  return _impl_.source_end_column_;
}
inline int32_t OpMetadata::source_end_column() const {
  // @@protoc_insertion_point(field_get:xla.OpMetadata.source_end_column)
  return _internal_source_end_column();
}
inline void OpMetadata::_internal_set_source_end_column(int32_t value) {
  
  _impl_.source_end_column_ = value;
}
inline void OpMetadata::set_source_end_column(int32_t value) {
  _internal_set_source_end_column(value);
  // @@protoc_insertion_point(field_set:xla.OpMetadata.source_end_column)
}
...
// string name = 1;
inline void MeshProto_MeshAxis::clear_name() {
  _impl_.name_.ClearToEmpty();
}
inline const std::string& MeshProto_MeshAxis::name() const {
  // @@protoc_insertion_point(field_get:xla.MeshProto.MeshAxis.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MeshProto_MeshAxis::set_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:xla.MeshProto.MeshAxis.name)
}
inline std::string* MeshProto_MeshAxis::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:xla.MeshProto.MeshAxis.name)
  return _s;
}
inline const std::string& MeshProto_MeshAxis::_internal_name() const {
  return _impl_.name_.Get();
}
inline void MeshProto_MeshAxis::_internal_set_name(const std::string& value) {
  
  _impl_.name_.Set(value, GetArenaForAllocation());
}
inline std::string* MeshProto_MeshAxis::_internal_mutable_name() {
  
  return _impl_.name_.Mutable(GetArenaForAllocation());
}
inline std::string* MeshProto_MeshAxis::release_name() {
  // @@protoc_insertion_point(field_release:xla.MeshProto.MeshAxis.name)
  return _impl_.name_.Release();
}
inline void MeshProto_MeshAxis::set_allocated_name(std::string* name) {
  if (name != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xla.MeshProto.MeshAxis.name)
}

// int64 size = 2;
inline void MeshProto_MeshAxis::clear_size() {
  _impl_.size_ = int64_t{0};
}
inline int64_t MeshProto_MeshAxis::_internal_size() const {
  return _impl_.size_;
}
inline int64_t MeshProto_MeshAxis::size() const {
  // @@protoc_insertion_point(field_get:xla.MeshProto.MeshAxis.size)
  return _internal_size();
}
inline void MeshProto_MeshAxis::_internal_set_size(int64_t value) {
  
  _impl_.size_ = value;
}
inline void MeshProto_MeshAxis::set_size(int64_t value) {
  _internal_set_size(value);
  // @@protoc_insertion_point(field_set:xla.MeshProto.MeshAxis.size)
}
...
// repeated .xla.MeshProto.MeshAxis axes = 1;
inline int MeshProto::_internal_axes_size() const {
  return _impl_.axes_.size();
}
inline int MeshProto::axes_size() const {
  return _internal_axes_size();
}
inline void MeshProto::clear_axes() {
  _impl_.axes_.Clear();
}
inline ::xla::MeshProto_MeshAxis* MeshProto::mutable_axes(int index) {
  // @@protoc_insertion_point(field_mutable:xla.MeshProto.axes)
  return _impl_.axes_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::MeshProto_MeshAxis >*
MeshProto::mutable_axes() {
  // @@protoc_insertion_point(field_mutable_list:xla.MeshProto.axes)
  return &_impl_.axes_;
}
inline const ::xla::MeshProto_MeshAxis& MeshProto::_internal_axes(int index) const {
  return _impl_.axes_.Get(index);
}
inline const ::xla::MeshProto_MeshAxis& MeshProto::axes(int index) const {
  // @@protoc_insertion_point(field_get:xla.MeshProto.axes)
  return _internal_axes(index);
}
inline ::xla::MeshProto_MeshAxis* MeshProto::_internal_add_axes() {
  return _impl_.axes_.Add();
}
inline ::xla::MeshProto_MeshAxis* MeshProto::add_axes() {
  ::xla::MeshProto_MeshAxis* _add = _internal_add_axes();
  // @@protoc_insertion_point(field_add:xla.MeshProto.axes)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::MeshProto_MeshAxis >&
MeshProto::axes() const {
  // @@protoc_insertion_point(field_list:xla.MeshProto.axes)
  return _impl_.axes_;
}

// repeated int64 device_ids = 2;
inline int MeshProto::_internal_device_ids_size() const {
  return _impl_.device_ids_.size();
}
inline int MeshProto::device_ids_size() const {
  return _internal_device_ids_size();
}
inline void MeshProto::clear_device_ids() {
  _impl_.device_ids_.Clear();
}
inline int64_t MeshProto::_internal_device_ids(int index) const {
  return _impl_.device_ids_.Get(index);
}
inline int64_t MeshProto::device_ids(int index) const {
  // @@protoc_insertion_point(field_get:xla.MeshProto.device_ids)
  return _internal_device_ids(index);
}
inline void MeshProto::set_device_ids(int index, int64_t value) {
  _impl_.device_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:xla.MeshProto.device_ids)
}
inline void MeshProto::_internal_add_device_ids(int64_t value) {
  _impl_.device_ids_.Add(value);
}
inline void MeshProto::add_device_ids(int64_t value) {
  _internal_add_device_ids(value);
  // @@protoc_insertion_point(field_add:xla.MeshProto.device_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
MeshProto::_internal_device_ids() const {
  return _impl_.device_ids_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
MeshProto::device_ids() const {
  // @@protoc_insertion_point(field_list:xla.MeshProto.device_ids)
  return _internal_device_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
MeshProto::_internal_mutable_device_ids() {
  return &_impl_.device_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
MeshProto::mutable_device_ids() {
  // @@protoc_insertion_point(field_mutable_list:xla.MeshProto.device_ids)
...
// int64 pre_size = 1;
inline void AxisRefProto_SubAxis::clear_pre_size() {
  _impl_.pre_size_ = int64_t{0};
}
inline int64_t AxisRefProto_SubAxis::_internal_pre_size() const {
  return _impl_.pre_size_;
}
inline int64_t AxisRefProto_SubAxis::pre_size() const {
  // @@protoc_insertion_point(field_get:xla.AxisRefProto.SubAxis.pre_size)
  return _internal_pre_size();
}
inline void AxisRefProto_SubAxis::_internal_set_pre_size(int64_t value) {
  
  _impl_.pre_size_ = value;
}
inline void AxisRefProto_SubAxis::set_pre_size(int64_t value) {
  _internal_set_pre_size(value);
  // @@protoc_insertion_point(field_set:xla.AxisRefProto.SubAxis.pre_size)
}

// int64 size = 2;
inline void AxisRefProto_SubAxis::clear_size() {
  _impl_.size_ = int64_t{0};
}
inline int64_t AxisRefProto_SubAxis::_internal_size() const {
  return _impl_.size_;
}
inline int64_t AxisRefProto_SubAxis::size() const {
  // @@protoc_insertion_point(field_get:xla.AxisRefProto.SubAxis.size)
  return _internal_size();
}
inline void AxisRefProto_SubAxis::_internal_set_size(int64_t value) {
  
  _impl_.size_ = value;
}
inline void AxisRefProto_SubAxis::set_size(int64_t value) {
  _internal_set_size(value);
  // @@protoc_insertion_point(field_set:xla.AxisRefProto.SubAxis.size)
}
...
// int64 mesh_axis_index = 1;
inline void AxisRefProto::clear_mesh_axis_index() {
  _impl_.mesh_axis_index_ = int64_t{0};
}
inline int64_t AxisRefProto::_internal_mesh_axis_index() const {
  return _impl_.mesh_axis_index_;
}
inline int64_t AxisRefProto::mesh_axis_index() const {
  // @@protoc_insertion_point(field_get:xla.AxisRefProto.mesh_axis_index)
  return _internal_mesh_axis_index();
}
inline void AxisRefProto::_internal_set_mesh_axis_index(int64_t value) {
  
  _impl_.mesh_axis_index_ = value;
}
inline void AxisRefProto::set_mesh_axis_index(int64_t value) {
  _internal_set_mesh_axis_index(value);
  // @@protoc_insertion_point(field_set:xla.AxisRefProto.mesh_axis_index)
}

// optional .xla.AxisRefProto.SubAxis sub_axis_info = 2;
inline bool AxisRefProto::_internal_has_sub_axis_info() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.sub_axis_info_ != nullptr);
  return value;
}
inline bool AxisRefProto::has_sub_axis_info() const {
  return _internal_has_sub_axis_info();
}
inline void AxisRefProto::clear_sub_axis_info() {
  if (_impl_.sub_axis_info_ != nullptr) _impl_.sub_axis_info_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::xla::AxisRefProto_SubAxis& AxisRefProto::_internal_sub_axis_info() const {
  const ::xla::AxisRefProto_SubAxis* p = _impl_.sub_axis_info_;
  return p != nullptr ? *p : reinterpret_cast<const ::xla::AxisRefProto_SubAxis&>(
      ::xla::_AxisRefProto_SubAxis_default_instance_);
}
inline const ::xla::AxisRefProto_SubAxis& AxisRefProto::sub_axis_info() const {
  // @@protoc_insertion_point(field_get:xla.AxisRefProto.sub_axis_info)
  return _internal_sub_axis_info();
}
inline void AxisRefProto::unsafe_arena_set_allocated_sub_axis_info(
    ::xla::AxisRefProto_SubAxis* sub_axis_info) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.sub_axis_info_);
  }
  _impl_.sub_axis_info_ = sub_axis_info;
  if (sub_axis_info) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xla.AxisRefProto.sub_axis_info)
}
inline ::xla::AxisRefProto_SubAxis* AxisRefProto::release_sub_axis_info() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::xla::AxisRefProto_SubAxis* temp = _impl_.sub_axis_info_;
  _impl_.sub_axis_info_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::xla::AxisRefProto_SubAxis* AxisRefProto::unsafe_arena_release_sub_axis_info() {
  // @@protoc_insertion_point(field_release:xla.AxisRefProto.sub_axis_info)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::xla::AxisRefProto_SubAxis* temp = _impl_.sub_axis_info_;
  _impl_.sub_axis_info_ = nullptr;
  return temp;
}
inline ::xla::AxisRefProto_SubAxis* AxisRefProto::_internal_mutable_sub_axis_info() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.sub_axis_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::xla::AxisRefProto_SubAxis>(GetArenaForAllocation());
    _impl_.sub_axis_info_ = p;
  }
  return _impl_.sub_axis_info_;
}
inline ::xla::AxisRefProto_SubAxis* AxisRefProto::mutable_sub_axis_info() {
  ::xla::AxisRefProto_SubAxis* _msg = _internal_mutable_sub_axis_info();
  // @@protoc_insertion_point(field_mutable:xla.AxisRefProto.sub_axis_info)
  return _msg;
}
inline void AxisRefProto::set_allocated_sub_axis_info(::xla::AxisRefProto_SubAxis* sub_axis_info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.sub_axis_info_;
  }
  if (sub_axis_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(sub_axis_info);
    if (message_arena != submessage_arena) {
      sub_axis_info = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, sub_axis_info, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  ...
  _impl_.sub_axis_info_ = sub_axis_info;
  // @@protoc_insertion_point(field_set_allocated:xla.AxisRefProto.sub_axis_info)
}
...
// repeated .xla.AxisRefProto axes = 1;
inline int NamedShardingProto_DimensionSharding::_internal_axes_size() const {
  return _impl_.axes_.size();
}
inline int NamedShardingProto_DimensionSharding::axes_size() const {
  return _internal_axes_size();
}
inline void NamedShardingProto_DimensionSharding::clear_axes() {
  _impl_.axes_.Clear();
}
inline ::xla::AxisRefProto* NamedShardingProto_DimensionSharding::mutable_axes(int index) {
  // @@protoc_insertion_point(field_mutable:xla.NamedShardingProto.DimensionSharding.axes)
  return _impl_.axes_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >*
NamedShardingProto_DimensionSharding::mutable_axes() {
  // @@protoc_insertion_point(field_mutable_list:xla.NamedShardingProto.DimensionSharding.axes)
  return &_impl_.axes_;
}
inline const ::xla::AxisRefProto& NamedShardingProto_DimensionSharding::_internal_axes(int index) const {
  return _impl_.axes_.Get(index);
}
inline const ::xla::AxisRefProto& NamedShardingProto_DimensionSharding::axes(int index) const {
  // @@protoc_insertion_point(field_get:xla.NamedShardingProto.DimensionSharding.axes)
  return _internal_axes(index);
}
inline ::xla::AxisRefProto* NamedShardingProto_DimensionSharding::_internal_add_axes() {
  return _impl_.axes_.Add();
}
inline ::xla::AxisRefProto* NamedShardingProto_DimensionSharding::add_axes() {
  ::xla::AxisRefProto* _add = _internal_add_axes();
  // @@protoc_insertion_point(field_add:xla.NamedShardingProto.DimensionSharding.axes)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >&
NamedShardingProto_DimensionSharding::axes() const {
  // @@protoc_insertion_point(field_list:xla.NamedShardingProto.DimensionSharding.axes)
  return _impl_.axes_;
}

// bool is_closed = 2;
inline void NamedShardingProto_DimensionSharding::clear_is_closed() {
  _impl_.is_closed_ = false;
}
inline bool NamedShardingProto_DimensionSharding::_internal_is_closed() const {
  return _impl_.is_closed_;
}
inline bool NamedShardingProto_DimensionSharding::is_closed() const {
  // @@protoc_insertion_point(field_get:xla.NamedShardingProto.DimensionSharding.is_closed)
  return _internal_is_closed();
}
inline void NamedShardingProto_DimensionSharding::_internal_set_is_closed(bool value) {
  
  _impl_.is_closed_ = value;
}
inline void NamedShardingProto_DimensionSharding::set_is_closed(bool value) {
  _internal_set_is_closed(value);
  // @@protoc_insertion_point(field_set:xla.NamedShardingProto.DimensionSharding.is_closed)
}
...
// .xla.MeshProto mesh = 2;
inline bool NamedShardingProto::_internal_has_mesh() const {
  return this != internal_default_instance() && _impl_.mesh_ != nullptr;
}
inline bool NamedShardingProto::has_mesh() const {
  return _internal_has_mesh();
}
inline void NamedShardingProto::clear_mesh() {
  if (GetArenaForAllocation() == nullptr && _impl_.mesh_ != nullptr) {
    delete _impl_.mesh_;
  }
  _impl_.mesh_ = nullptr;
}
inline const ::xla::MeshProto& NamedShardingProto::_internal_mesh() const {
  const ::xla::MeshProto* p = _impl_.mesh_;
  return p != nullptr ? *p : reinterpret_cast<const ::xla::MeshProto&>(
      ::xla::_MeshProto_default_instance_);
}
inline const ::xla::MeshProto& NamedShardingProto::mesh() const {
  // @@protoc_insertion_point(field_get:xla.NamedShardingProto.mesh)
  return _internal_mesh();
}
inline void NamedShardingProto::unsafe_arena_set_allocated_mesh(
    ::xla::MeshProto* mesh) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xla.NamedShardingProto.mesh)
}
inline ::xla::MeshProto* NamedShardingProto::release_mesh() {
  
  ::xla::MeshProto* temp = _impl_.mesh_;
  _impl_.mesh_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::xla::MeshProto* NamedShardingProto::unsafe_arena_release_mesh() {
  // @@protoc_insertion_point(field_release:xla.NamedShardingProto.mesh)
  
  ::xla::MeshProto* temp = _impl_.mesh_;
  _impl_.mesh_ = nullptr;
  return temp;
}
inline ::xla::MeshProto* NamedShardingProto::_internal_mutable_mesh() {
  
  if (_impl_.mesh_ == nullptr) {
    auto* p = CreateMaybeMessage<::xla::MeshProto>(GetArenaForAllocation());
    _impl_.mesh_ = p;
  }
  return _impl_.mesh_;
}
inline ::xla::MeshProto* NamedShardingProto::mutable_mesh() {
  ::xla::MeshProto* _msg = _internal_mutable_mesh();
  // @@protoc_insertion_point(field_mutable:xla.NamedShardingProto.mesh)
  return _msg;
}
inline void NamedShardingProto::set_allocated_mesh(::xla::MeshProto* mesh) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.mesh_;
  }
  ...
  _impl_.mesh_ = mesh;
  // @@protoc_insertion_point(field_set_allocated:xla.NamedShardingProto.mesh)
}

// repeated .xla.NamedShardingProto.DimensionSharding dim_shardings = 3;
inline int NamedShardingProto::_internal_dim_shardings_size() const {
  return _impl_.dim_shardings_.size();
}
inline int NamedShardingProto::dim_shardings_size() const {
  return _internal_dim_shardings_size();
}
inline void NamedShardingProto::clear_dim_shardings() {
  _impl_.dim_shardings_.Clear();
}
inline ::xla::NamedShardingProto_DimensionSharding* NamedShardingProto::mutable_dim_shardings(int index) {
  // @@protoc_insertion_point(field_mutable:xla.NamedShardingProto.dim_shardings)
  return _impl_.dim_shardings_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::NamedShardingProto_DimensionSharding >*
NamedShardingProto::mutable_dim_shardings() {
  // @@protoc_insertion_point(field_mutable_list:xla.NamedShardingProto.dim_shardings)
  return &_impl_.dim_shardings_;
}
inline const ::xla::NamedShardingProto_DimensionSharding& NamedShardingProto::_internal_dim_shardings(int index) const {
  return _impl_.dim_shardings_.Get(index);
}
inline const ::xla::NamedShardingProto_DimensionSharding& NamedShardingProto::dim_shardings(int index) const {
  // @@protoc_insertion_point(field_get:xla.NamedShardingProto.dim_shardings)
  return _internal_dim_shardings(index);
}
inline ::xla::NamedShardingProto_DimensionSharding* NamedShardingProto::_internal_add_dim_shardings() {
  return _impl_.dim_shardings_.Add();
}
inline ::xla::NamedShardingProto_DimensionSharding* NamedShardingProto::add_dim_shardings() {
  ::xla::NamedShardingProto_DimensionSharding* _add = _internal_add_dim_shardings();
  // @@protoc_insertion_point(field_add:xla.NamedShardingProto.dim_shardings)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::NamedShardingProto_DimensionSharding >&
NamedShardingProto::dim_shardings() const {
  // @@protoc_insertion_point(field_list:xla.NamedShardingProto.dim_shardings)
  return _impl_.dim_shardings_;
}

// repeated .xla.AxisRefProto replicated_axes = 4;
inline int NamedShardingProto::_internal_replicated_axes_size() const {
  return _impl_.replicated_axes_.size();
}
inline int NamedShardingProto::replicated_axes_size() const {
  return _internal_replicated_axes_size();
}
inline void NamedShardingProto::clear_replicated_axes() {
  _impl_.replicated_axes_.Clear();
}
inline ::xla::AxisRefProto* NamedShardingProto::mutable_replicated_axes(int index) {
  // @@protoc_insertion_point(field_mutable:xla.NamedShardingProto.replicated_axes)
  return _impl_.replicated_axes_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >*
NamedShardingProto::mutable_replicated_axes() {
  // @@protoc_insertion_point(field_mutable_list:xla.NamedShardingProto.replicated_axes)
  return &_impl_.replicated_axes_;
}
inline const ::xla::AxisRefProto& NamedShardingProto::_internal_replicated_axes(int index) const {
  return _impl_.replicated_axes_.Get(index);
}
inline const ::xla::AxisRefProto& NamedShardingProto::replicated_axes(int index) const {
  // @@protoc_insertion_point(field_get:xla.NamedShardingProto.replicated_axes)
  return _internal_replicated_axes(index);
}
inline ::xla::AxisRefProto* NamedShardingProto::_internal_add_replicated_axes() {
  return _impl_.replicated_axes_.Add();
}
inline ::xla::AxisRefProto* NamedShardingProto::add_replicated_axes() {
  ::xla::AxisRefProto* _add = _internal_add_replicated_axes();
  // @@protoc_insertion_point(field_add:xla.NamedShardingProto.replicated_axes)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >&
NamedShardingProto::replicated_axes() const {
  // @@protoc_insertion_point(field_list:xla.NamedShardingProto.replicated_axes)
  return _impl_.replicated_axes_;
}

// repeated .xla.AxisRefProto unreduced_axes = 5;
inline int NamedShardingProto::_internal_unreduced_axes_size() const {
  return _impl_.unreduced_axes_.size();
}
inline int NamedShardingProto::unreduced_axes_size() const {
  return _internal_unreduced_axes_size();
}
inline void NamedShardingProto::clear_unreduced_axes() {
  _impl_.unreduced_axes_.Clear();
}
inline ::xla::AxisRefProto* NamedShardingProto::mutable_unreduced_axes(int index) {
  // @@protoc_insertion_point(field_mutable:xla.NamedShardingProto.unreduced_axes)
  return _impl_.unreduced_axes_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >*
NamedShardingProto::mutable_unreduced_axes() {
  // @@protoc_insertion_point(field_mutable_list:xla.NamedShardingProto.unreduced_axes)
  return &_impl_.unreduced_axes_;
}
inline const ::xla::AxisRefProto& NamedShardingProto::_internal_unreduced_axes(int index) const {
  return _impl_.unreduced_axes_.Get(index);
}
inline const ::xla::AxisRefProto& NamedShardingProto::unreduced_axes(int index) const {
  // @@protoc_insertion_point(field_get:xla.NamedShardingProto.unreduced_axes)
  return _internal_unreduced_axes(index);
}
inline ::xla::AxisRefProto* NamedShardingProto::_internal_add_unreduced_axes() {
  return _impl_.unreduced_axes_.Add();
}
inline ::xla::AxisRefProto* NamedShardingProto::add_unreduced_axes() {
  ::xla::AxisRefProto* _add = _internal_add_unreduced_axes();
  // @@protoc_insertion_point(field_add:xla.NamedShardingProto.unreduced_axes)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >&
NamedShardingProto::unreduced_axes() const {
  // @@protoc_insertion_point(field_list:xla.NamedShardingProto.unreduced_axes)
  return _impl_.unreduced_axes_;
}

// repeated .xla.OpMetadata metadata = 6;
inline int NamedShardingProto::_internal_metadata_size() const {
  return _impl_.metadata_.size();
}
inline int NamedShardingProto::metadata_size() const {
  return _internal_metadata_size();
}
inline void NamedShardingProto::clear_metadata() {
  _impl_.metadata_.Clear();
}
inline ::xla::OpMetadata* NamedShardingProto::mutable_metadata(int index) {
  // @@protoc_insertion_point(field_mutable:xla.NamedShardingProto.metadata)
  return _impl_.metadata_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::OpMetadata >*
NamedShardingProto::mutable_metadata() {
  // @@protoc_insertion_point(field_mutable_list:xla.NamedShardingProto.metadata)
  return &_impl_.metadata_;
}
inline const ::xla::OpMetadata& NamedShardingProto::_internal_metadata(int index) const {
  return _impl_.metadata_.Get(index);
}
inline const ::xla::OpMetadata& NamedShardingProto::metadata(int index) const {
  // @@protoc_insertion_point(field_get:xla.NamedShardingProto.metadata)
  return _internal_metadata(index);
}
inline ::xla::OpMetadata* NamedShardingProto::_internal_add_metadata() {
  return _impl_.metadata_.Add();
}
inline ::xla::OpMetadata* NamedShardingProto::add_metadata() {
  ::xla::OpMetadata* _add = _internal_add_metadata();
  // @@protoc_insertion_point(field_add:xla.NamedShardingProto.metadata)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::OpMetadata >&
NamedShardingProto::metadata() const {
  // @@protoc_insertion_point(field_list:xla.NamedShardingProto.metadata)
  return _impl_.metadata_;
}
...
// optional .xla.NamedShardingProto named_sharding = 14;
inline bool OpSharding::_internal_has_named_sharding() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.named_sharding_ != nullptr);
  return value;
}
inline bool OpSharding::has_named_sharding() const {
  return _internal_has_named_sharding();
}
inline void OpSharding::clear_named_sharding() {
  if (_impl_.named_sharding_ != nullptr) _impl_.named_sharding_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::xla::NamedShardingProto& OpSharding::_internal_named_sharding() const {
  const ::xla::NamedShardingProto* p = _impl_.named_sharding_;
  return p != nullptr ? *p : reinterpret_cast<const ::xla::NamedShardingProto&>(
      ::xla::_NamedShardingProto_default_instance_);
}
inline const ::xla::NamedShardingProto& OpSharding::named_sharding() const {
  // @@protoc_insertion_point(field_get:xla.OpSharding.named_sharding)
  return _internal_named_sharding();
}
inline void OpSharding::unsafe_arena_set_allocated_named_sharding(
    ::xla::NamedShardingProto* named_sharding) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.named_sharding_);
  }
  _impl_.named_sharding_ = named_sharding;
  if (named_sharding) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xla.OpSharding.named_sharding)
}
inline ::xla::NamedShardingProto* OpSharding::release_named_sharding() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::xla::NamedShardingProto* temp = _impl_.named_sharding_;
  _impl_.named_sharding_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::xla::NamedShardingProto* OpSharding::unsafe_arena_release_named_sharding() {
  // @@protoc_insertion_point(field_release:xla.OpSharding.named_sharding)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::xla::NamedShardingProto* temp = _impl_.named_sharding_;
  _impl_.named_sharding_ = nullptr;
  return temp;
}
inline ::xla::NamedShardingProto* OpSharding::_internal_mutable_named_sharding() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.named_sharding_ == nullptr) {
    auto* p = CreateMaybeMessage<::xla::NamedShardingProto>(GetArenaForAllocation());
    _impl_.named_sharding_ = p;
  }
  return _impl_.named_sharding_;
}
inline ::xla::NamedShardingProto* OpSharding::mutable_named_sharding() {
  ::xla::NamedShardingProto* _msg = _internal_mutable_named_sharding();
  // @@protoc_insertion_point(field_mutable:xla.OpSharding.named_sharding)
  return _msg;
}
inline void OpSharding::set_allocated_named_sharding(::xla::NamedShardingProto* named_sharding) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.named_sharding_;
  }
  if (named_sharding) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(named_sharding);
    if (message_arena != submessage_arena) {
      named_sharding = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, named_sharding, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  ...
  _impl_.named_sharding_ = named_sharding;
  // @@protoc_insertion_point(field_set_allocated:xla.OpSharding.named_sharding)
}
...
// .xla.MeshProto mesh = 1;
inline bool MeshAxesReplicaGroupListProto::_internal_has_mesh() const {
  return this != internal_default_instance() && _impl_.mesh_ != nullptr;
}
inline bool MeshAxesReplicaGroupListProto::has_mesh() const {
  return _internal_has_mesh();
}
inline void MeshAxesReplicaGroupListProto::clear_mesh() {
  if (GetArenaForAllocation() == nullptr && _impl_.mesh_ != nullptr) {
    delete _impl_.mesh_;
  }
  _impl_.mesh_ = nullptr;
}
inline const ::xla::MeshProto& MeshAxesReplicaGroupListProto::_internal_mesh() const {
  const ::xla::MeshProto* p = _impl_.mesh_;
  return p != nullptr ? *p : reinterpret_cast<const ::xla::MeshProto&>(
      ::xla::_MeshProto_default_instance_);
}
inline const ::xla::MeshProto& MeshAxesReplicaGroupListProto::mesh() const {
  // @@protoc_insertion_point(field_get:xla.MeshAxesReplicaGroupListProto.mesh)
  return _internal_mesh();
}
inline void MeshAxesReplicaGroupListProto::unsafe_arena_set_allocated_mesh(
    ::xla::MeshProto* mesh) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.mesh_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xla.MeshAxesReplicaGroupListProto.mesh)
}
inline ::xla::MeshProto* MeshAxesReplicaGroupListProto::release_mesh() {
...
inline ::xla::MeshProto* MeshAxesReplicaGroupListProto::unsafe_arena_release_mesh() {
  // @@protoc_insertion_point(field_release:xla.MeshAxesReplicaGroupListProto.mesh)
  
  ::xla::MeshProto* temp = _impl_.mesh_;
  _impl_.mesh_ = nullptr;
  return temp;
}
inline ::xla::MeshProto* MeshAxesReplicaGroupListProto::_internal_mutable_mesh() {
...
inline ::xla::MeshProto* MeshAxesReplicaGroupListProto::mutable_mesh() {
  ::xla::MeshProto* _msg = _internal_mutable_mesh();
  // @@protoc_insertion_point(field_mutable:xla.MeshAxesReplicaGroupListProto.mesh)
  return _msg;
}
inline void MeshAxesReplicaGroupListProto::set_allocated_mesh(::xla::MeshProto* mesh) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.mesh_;
  }
  ...
  _impl_.mesh_ = mesh;
  // @@protoc_insertion_point(field_set_allocated:xla.MeshAxesReplicaGroupListProto.mesh)
}

// repeated .xla.AxisRefProto axes = 2;
inline int MeshAxesReplicaGroupListProto::_internal_axes_size() const {
  return _impl_.axes_.size();
}
inline int MeshAxesReplicaGroupListProto::axes_size() const {
  return _internal_axes_size();
}
inline void MeshAxesReplicaGroupListProto::clear_axes() {
  _impl_.axes_.Clear();
}
inline ::xla::AxisRefProto* MeshAxesReplicaGroupListProto::mutable_axes(int index) {
  // @@protoc_insertion_point(field_mutable:xla.MeshAxesReplicaGroupListProto.axes)
  return _impl_.axes_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >*
MeshAxesReplicaGroupListProto::mutable_axes() {
  // @@protoc_insertion_point(field_mutable_list:xla.MeshAxesReplicaGroupListProto.axes)
  return &_impl_.axes_;
}
inline const ::xla::AxisRefProto& MeshAxesReplicaGroupListProto::_internal_axes(int index) const {
  return _impl_.axes_.Get(index);
}
inline const ::xla::AxisRefProto& MeshAxesReplicaGroupListProto::axes(int index) const {
  // @@protoc_insertion_point(field_get:xla.MeshAxesReplicaGroupListProto.axes)
  return _internal_axes(index);
}
inline ::xla::AxisRefProto* MeshAxesReplicaGroupListProto::_internal_add_axes() {
  return _impl_.axes_.Add();
}
inline ::xla::AxisRefProto* MeshAxesReplicaGroupListProto::add_axes() {
  ::xla::AxisRefProto* _add = _internal_add_axes();
  // @@protoc_insertion_point(field_add:xla.MeshAxesReplicaGroupListProto.axes)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::AxisRefProto >&
MeshAxesReplicaGroupListProto::axes() const {
  // @@protoc_insertion_point(field_list:xla.MeshAxesReplicaGroupListProto.axes)
  return _impl_.axes_;
}
...
// .xla.WhileLoopBackendConfig.KnownInitStep known_init_step = 2;
inline bool WhileLoopBackendConfig::_internal_has_known_init_step() const {
  return this != internal_default_instance() && _impl_.known_init_step_ != nullptr;
}
inline bool WhileLoopBackendConfig::has_known_init_step() const {
  return _internal_has_known_init_step();
}
...
inline const ::xla::WhileLoopBackendConfig_KnownInitStep& WhileLoopBackendConfig::_internal_known_init_step() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::xla::WhileLoopBackendConfig_KnownInitStep&>(
      ::xla::_WhileLoopBackendConfig_KnownInitStep_default_instance_);
}
inline const ::xla::WhileLoopBackendConfig_KnownInitStep& WhileLoopBackendConfig::known_init_step() const {
  // @@protoc_insertion_point(field_get:xla.WhileLoopBackendConfig.known_init_step)
  return _internal_known_init_step();
}
inline void WhileLoopBackendConfig::unsafe_arena_set_allocated_known_init_step(
    ::xla::WhileLoopBackendConfig_KnownInitStep* known_init_step) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.known_init_step_);
  }
  _impl_.known_init_step_ = known_init_step;
  if (known_init_step) {
...
inline ::xla::WhileLoopBackendConfig_KnownInitStep* WhileLoopBackendConfig::_internal_mutable_known_init_step() {
  ...
  if (_impl_.known_init_step_ == nullptr) {
    auto* p = CreateMaybeMessage<::xla::WhileLoopBackendConfig_KnownInitStep>(GetArenaForAllocation());
    _impl_.known_init_step_ = p;
  }
  return _impl_.known_init_step_;
}
inline ::xla::WhileLoopBackendConfig_KnownInitStep* WhileLoopBackendConfig::mutable_known_init_step() {
...
inline void WhileLoopBackendConfig::set_allocated_known_init_step(::xla::WhileLoopBackendConfig_KnownInitStep* known_init_step) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.known_init_step_;
  }
  if (known_init_step) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(known_init_step);
    if (message_arena != submessage_arena) {
      known_init_step = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, known_init_step, submessage_arena);
    }
...
// .xla.WhileLoopBackendConfig.KnownInductionVariable known_induction_variable = 3;
inline bool WhileLoopBackendConfig::_internal_has_known_induction_variable() const {
  return this != internal_default_instance() && _impl_.known_induction_variable_ != nullptr;
}
inline bool WhileLoopBackendConfig::has_known_induction_variable() const {
  return _internal_has_known_induction_variable();
}
...
inline const ::xla::WhileLoopBackendConfig_KnownInductionVariable& WhileLoopBackendConfig::_internal_known_induction_variable() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::xla::WhileLoopBackendConfig_KnownInductionVariable&>(
      ::xla::_WhileLoopBackendConfig_KnownInductionVariable_default_instance_);
}
inline const ::xla::WhileLoopBackendConfig_KnownInductionVariable& WhileLoopBackendConfig::known_induction_variable() const {
...
inline void WhileLoopBackendConfig::unsafe_arena_set_allocated_known_induction_variable(
    ::xla::WhileLoopBackendConfig_KnownInductionVariable* known_induction_variable) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.known_induction_variable_);
  }
  _impl_.known_induction_variable_ = known_induction_variable;
  if (known_induction_variable) {
...
inline ::xla::WhileLoopBackendConfig_KnownInductionVariable* WhileLoopBackendConfig::_internal_mutable_known_induction_variable() {
  ...
  if (_impl_.known_induction_variable_ == nullptr) {
    auto* p = CreateMaybeMessage<::xla::WhileLoopBackendConfig_KnownInductionVariable>(GetArenaForAllocation());
    _impl_.known_induction_variable_ = p;
  }
  return _impl_.known_induction_variable_;
}
inline ::xla::WhileLoopBackendConfig_KnownInductionVariable* WhileLoopBackendConfig::mutable_known_induction_variable() {
...
inline void WhileLoopBackendConfig::set_allocated_known_induction_variable(::xla::WhileLoopBackendConfig_KnownInductionVariable* known_induction_variable) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.known_induction_variable_;
  }
  if (known_induction_variable) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(known_induction_variable);
    if (message_arena != submessage_arena) {
      known_induction_variable = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, known_induction_variable, submessage_arena);
    }
...
// repeated int64 shape_index = 1;
inline int OriginalValueElementProto::_internal_shape_index_size() const {
  return _impl_.shape_index_.size();
}
inline int OriginalValueElementProto::shape_index_size() const {
  return _internal_shape_index_size();
}
inline void OriginalValueElementProto::clear_shape_index() {
  _impl_.shape_index_.Clear();
}
inline int64_t OriginalValueElementProto::_internal_shape_index(int index) const {
  return _impl_.shape_index_.Get(index);
}
inline int64_t OriginalValueElementProto::shape_index(int index) const {
  // @@protoc_insertion_point(field_get:xla.OriginalValueElementProto.shape_index)
  return _internal_shape_index(index);
}
inline void OriginalValueElementProto::set_shape_index(int index, int64_t value) {
  _impl_.shape_index_.Set(index, value);
  // @@protoc_insertion_point(field_set:xla.OriginalValueElementProto.shape_index)
}
inline void OriginalValueElementProto::_internal_add_shape_index(int64_t value) {
  _impl_.shape_index_.Add(value);
}
inline void OriginalValueElementProto::add_shape_index(int64_t value) {
  _internal_add_shape_index(value);
  // @@protoc_insertion_point(field_add:xla.OriginalValueElementProto.shape_index)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
OriginalValueElementProto::_internal_shape_index() const {
  return _impl_.shape_index_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
OriginalValueElementProto::shape_index() const {
  // @@protoc_insertion_point(field_list:xla.OriginalValueElementProto.shape_index)
  return _internal_shape_index();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
OriginalValueElementProto::_internal_mutable_shape_index() {
  return &_impl_.shape_index_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
OriginalValueElementProto::mutable_shape_index() {
  // @@protoc_insertion_point(field_mutable_list:xla.OriginalValueElementProto.shape_index)
  return _internal_mutable_shape_index();
}

// .xla.OriginalArrayProto original_array = 2;
inline bool OriginalValueElementProto::_internal_has_original_array() const {
  return this != internal_default_instance() && _impl_.original_array_ != nullptr;
}
inline bool OriginalValueElementProto::has_original_array() const {
  return _internal_has_original_array();
}
inline void OriginalValueElementProto::clear_original_array() {
...
inline const ::xla::OriginalArrayProto& OriginalValueElementProto::_internal_original_array() const {
  const ::xla::OriginalArrayProto* p = _impl_.original_array_;
  return p != nullptr ? *p : reinterpret_cast<const ::xla::OriginalArrayProto&>(
      ::xla::_OriginalArrayProto_default_instance_);
}
inline const ::xla::OriginalArrayProto& OriginalValueElementProto::original_array() const {
  // @@protoc_insertion_point(field_get:xla.OriginalValueElementProto.original_array)
  return _internal_original_array();
}
inline void OriginalValueElementProto::unsafe_arena_set_allocated_original_array(
    ::xla::OriginalArrayProto* original_array) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.original_array_);
  }
  _impl_.original_array_ = original_array;
  if (original_array) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xla.OriginalValueElementProto.original_array)
}
inline ::xla::OriginalArrayProto* OriginalValueElementProto::release_original_array() {
...
inline ::xla::OriginalArrayProto* OriginalValueElementProto::unsafe_arena_release_original_array() {
  // @@protoc_insertion_point(field_release:xla.OriginalValueElementProto.original_array)
  
  ::xla::OriginalArrayProto* temp = _impl_.original_array_;
  _impl_.original_array_ = nullptr;
  return temp;
}
inline ::xla::OriginalArrayProto* OriginalValueElementProto::_internal_mutable_original_array() {
  
  if (_impl_.original_array_ == nullptr) {
    auto* p = CreateMaybeMessage<::xla::OriginalArrayProto>(GetArenaForAllocation());
    _impl_.original_array_ = p;
  }
  return _impl_.original_array_;
}
inline ::xla::OriginalArrayProto* OriginalValueElementProto::mutable_original_array() {
  ::xla::OriginalArrayProto* _msg = _internal_mutable_original_array();
  // @@protoc_insertion_point(field_mutable:xla.OriginalValueElementProto.original_array)
  return _msg;
}
inline void OriginalValueElementProto::set_allocated_original_array(::xla::OriginalArrayProto* original_array) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.original_array_;
  }
  if (original_array) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(original_array);
    if (message_arena != submessage_arena) {
      original_array = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, original_array, submessage_arena);
    }
  ...
  _impl_.original_array_ = original_array;
  // @@protoc_insertion_point(field_set_allocated:xla.OriginalValueElementProto.original_array)
}
...
// repeated .xla.OriginalValueElementProto elements = 1;
inline int OriginalValueProto::_internal_elements_size() const {
  return _impl_.elements_.size();
}
inline int OriginalValueProto::elements_size() const {
  return _internal_elements_size();
}
inline void OriginalValueProto::clear_elements() {
  _impl_.elements_.Clear();
}
inline ::xla::OriginalValueElementProto* OriginalValueProto::mutable_elements(int index) {
  // @@protoc_insertion_point(field_mutable:xla.OriginalValueProto.elements)
  return _impl_.elements_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::OriginalValueElementProto >*
OriginalValueProto::mutable_elements() {
  // @@protoc_insertion_point(field_mutable_list:xla.OriginalValueProto.elements)
  return &_impl_.elements_;
}
inline const ::xla::OriginalValueElementProto& OriginalValueProto::_internal_elements(int index) const {
  return _impl_.elements_.Get(index);
}
inline const ::xla::OriginalValueElementProto& OriginalValueProto::elements(int index) const {
  // @@protoc_insertion_point(field_get:xla.OriginalValueProto.elements)
  return _internal_elements(index);
}
inline ::xla::OriginalValueElementProto* OriginalValueProto::_internal_add_elements() {
  return _impl_.elements_.Add();
}
inline ::xla::OriginalValueElementProto* OriginalValueProto::add_elements() {
  ::xla::OriginalValueElementProto* _add = _internal_add_elements();
  // @@protoc_insertion_point(field_add:xla.OriginalValueProto.elements)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::OriginalValueElementProto >&
OriginalValueProto::elements() const {
  // @@protoc_insertion_point(field_list:xla.OriginalValueProto.elements)
  return _impl_.elements_;
}

// bool is_synthetic_call = 2;
inline void OriginalValueProto::clear_is_synthetic_call() {
  _impl_.is_synthetic_call_ = false;
}
inline bool OriginalValueProto::_internal_is_synthetic_call() const {
  return _impl_.is_synthetic_call_;
}
inline bool OriginalValueProto::is_synthetic_call() const {
  // @@protoc_insertion_point(field_get:xla.OriginalValueProto.is_synthetic_call)
  return _internal_is_synthetic_call();
}
inline void OriginalValueProto::_internal_set_is_synthetic_call(bool value) {
  
  _impl_.is_synthetic_call_ = value;
}
inline void OriginalValueProto::set_is_synthetic_call(bool value) {
  _internal_set_is_synthetic_call(value);
  // @@protoc_insertion_point(field_set:xla.OriginalValueProto.is_synthetic_call)
}
...
GemmPerfTableEntry::_internal_flops() const {
  return _impl_.flops_.GetMap();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< std::string, int64_t >&
GemmPerfTableEntry::flops() const {
...
GemmPerfTableEntry::_internal_mutable_flops() {
  return _impl_.flops_.MutableMap();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, int64_t >*
GemmPerfTableEntry::mutable_flops() {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::GemmPerfTableEntry >*
GemmPerfTableEntryValues::mutable_entries() {
  // @@protoc_insertion_point(field_mutable_list:xla.GemmPerfTableEntryValues.entries)
  return &_impl_.entries_;
}
inline const ::xla::GemmPerfTableEntry& GemmPerfTableEntryValues::_internal_entries(int index) const {
...
inline ::xla::GemmPerfTableEntry* GemmPerfTableEntryValues::_internal_add_entries() {
  return _impl_.entries_.Add();
}
inline ::xla::GemmPerfTableEntry* GemmPerfTableEntryValues::add_entries() {
  ::xla::GemmPerfTableEntry* _add = _internal_add_entries();
  // @@protoc_insertion_point(field_add:xla.GemmPerfTableEntryValues.entries)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::GemmPerfTableEntry >&
GemmPerfTableEntryValues::entries() const {
...
inline const ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::xla::GemmPerfTableEntryValues >&
GemmPerfTable::_internal_entries() const {
  return _impl_.entries_.GetMap();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::xla::GemmPerfTableEntryValues >&
GemmPerfTable::entries() const {
  // @@protoc_insertion_point(field_map:xla.GemmPerfTable.entries)
  return _internal_entries();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::xla::GemmPerfTableEntryValues >*
GemmPerfTable::_internal_mutable_entries() {
  return _impl_.entries_.MutableMap();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::xla::GemmPerfTableEntryValues >*
GemmPerfTable::mutable_entries() {
...
template <> struct is_proto_enum< ::xla::AsyncStreamKind> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::xla::AsyncStreamKind>() {
  return ::xla::AsyncStreamKind_descriptor();
}
template <> struct is_proto_enum< ::xla::CollectiveOpGroupMode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::xla::CollectiveOpGroupMode>() {
  return ::xla::CollectiveOpGroupMode_descriptor();
}
...
template <> struct is_proto_enum< ::xla::ProfileGenerationStrategy> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::xla::ProfileGenerationStrategy>() {
  return ::xla::ProfileGenerationStrategy_descriptor();
}
